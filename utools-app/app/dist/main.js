(() => {
  ...
  const l = require("fs");
  var d = e.n(l);
  const u = require("configuration")
    , h = require("crypto");
  var p = e.n(h);
  const w = require("os");
  var m = e.n(w);
  const g = require("original-fs");
  var f = e.n(g);
  const y = require("internal-ip");
  var b = e.n(y);
  const C = require("addon");
  var v = e.n(C);
  let S, W;
  function P() {
    return S || (S = v().getLocalSecretKey()),
      S
  }
  function D() {
  ...
  function x(e) {
    return p().createHash("md5").update(e).digest("hex")
  }
  function k(e) {
    return new Promise(((t, i) => {
      const n = p().createHash("md5");
      n.on("error", i).setEncoding("hex"),
        f().createReadStream(e, {
  ...
  function _() {
    return x(D() + D() + D() + D() + D() + D() + D() + D() + Date.now())
  }
  function I(e) {
  ...
  function M(e) {
    const t = p().createCipheriv("aes-256-cbc", P(), "UTOOLS0123456789");
  ...
  function F(e) {
    if (!e)
      return "";
    try {
      const t = p().createDecipheriv("aes-256-cbc", P(), "UTOOLS0123456789");
  ...
  async function E() {
    ...
    if (e)
      return e;
    const t = [].concat.apply([], Object.values(m().networkInterfaces())).find((e => "IPv4" === e.family && "127.0.0.1" !== e.address && !e.internal));
  ...
  function B() {
    if (!W) {
      if (r().dev())
        return "utools-dev";
      W = JSON.parse(d().readFileSync(c().join(__dirname, "..", "package.json"), "utf-8")).name
    }
    return W
  }
  const V = function() {
  ...
  let L = t.app.getPath("userData");
  r().dev() && (L = c().join(t.app.getPath("appData"), R() ? "dev-utools" : "dev-utools-ee"),
    d().existsSync(L) || d().mkdirSync(L));
  const N = {
    path: {
      root: L,
      plugins: c().join(L, "plugins"),
      database: c().join(L, "database"),
      settings: c().join(L, "settings"),
      clipboardData: c().join(L, "clipboard-data")
    },
    app: {
      apiHost: u.apiHost,
      redirectURL: u.apiHost + "/redirect?target=",
      newestVersionURL: u.newestVersionURL
    },
    database: {
      sync: u.dbSync
    },
    window: {
      ...
      messageBadgeColor: u.messageBadgeColor,
      disableRenderRecent: u.disableRenderRecent,
      isForceLogin: Boolean(u.forceLogin),
      backgroundColor: "#FFFFFF",
      darkBackgroundColor: "#303133",
      initHeight: 56,
      initWidth: 800,
      openPluginHeight: 600,
      pluginDownloadURL: u.apiHost + "/plugins/{query}/download"
    },
    plugin: {
      checkUpdateURL: u.apiHost + "/plugins/plugin_update_check",
      hashURL: u.apiHost + "/plugins/{query}/hash"
    },
    report: {
      logsURL: u.apiHost + "/logs?access_token=",
      interval: 6e4
    },
    account: {
      apiHost: u.apiHost,
      forceLogin: u.forceLogin,
      muserURL: u.apiHost + "/muser?access_token=",
      profileURL: u.apiHost + "/profile",
      dbSyncURL: u.apiHost + "/database/sync",
      logoutURL: u.apiHost + "/logout",
      temporaryToken: u.apiHost + "/temporary_token",
      tokenValidURL: u.apiHost + "/token/valid"
    },
    voice: {
      contentWidth: 255,
      initContentHeight: 56,
      translateURL: u.apiHost + "/translates?access_token="
    },
    pay: {
      paymentsURL: u.apiHost + "/payments?access_token=",
      payCodeURL: u.apiHost + "/payments/{query}/pay_code?access_token=",
      payStatusURL: u.apiHost + "/payments/{query}/pay_status?access_token="
    },
    messagehub: {
      messagesURL: u.apiHost + "/messages?access_token=",
      interval: 6e4
    },
    helpboot: {
      pluginsURL: u.apiHost + "/plugins?tag_id=0&platform=" + process.platform + "&mid=00000000000000000000000000000000&nid=00000000000000000000000000000000&used_by=first_install"
    }
  }
    , U = {}
    , H = require("url")
    ...
    return new Promise(((n, o) => {
      ...
      (/^https:/i.test(e) ? K().get : $().get)(e, (e => {
        if (200 === e.statusCode) {
          ...
          301 === e.statusCode || 302 === e.statusCode ? Z(e.headers.location, i).then(n).catch(o) : o(new Error("error status code: " + e.statusCode))
      }
      )).on("error", o)
    }
    ))
  }
  const X = require("asar");
  var Y = e.n(X);
  const z = require("zlib");
  var ee = e.n(z);
  const te = require("semver");
  var ie = e.n(te)
    , ne = {
    ...
    , ae = {};
  for (var ce in ne)
    for (var le = ne[ce].split(","), de = 0; de < le.length; de++)
      for (var ue = le[de], he = 0; he < ue.length; he += 2) {
        var pe = ue.substring(he, he + 2)
          , we = String.fromCharCode(se(pe) + 19968 + 6976 * de);
        re[ce] ? re[ce] += we : re[ce] = we,
          ae[we] ? ae[we] += "," + ce : ae[we] = ce
      }
  ne = null;
  const me = {
    getSpell: function(e, t, i) {
      ...
      for (var s, r, a = 0; a < e.length; a++)
        s = e[a],
          ae.hasOwnProperty(s) ? ~(r = ae[s]).indexOf(",") ? (r = r.split(","),
            r = o ? t(s, r) : "[" + r + "]",
            n.push(r)) : n.push(r) : n.push(s);
      return n.join(i || ",")
    },
    getChars: function(e) {
      return re.hasOwnProperty(e) ? re[e].split("") : []
    }
  };
  function ge(e) {
    const t = me.getSpell(e)
      , i = [t]
      , n = t.match(/\[[a-z,]+\]/g);
    if (n)
      for (const e of n) {
  ...
  function be(e) {
    ...
    for (const i of e.cmds)
      if ("string" != typeof i) {
        if (i && i.type && i.label && "string" == typeof i.label && !(i.label.length > 80))
          if ("regex" !== i.type)
            if ("files" !== i.type)
              if ("img" !== i.type)
                if ("over" !== i.type)
                  if ("window" !== i.type)
                    ...
                    if (i.match.app) {
                      ...
                      i.match.title && ye(i.match.title) && (e.match.title = i.match.title)
                    }
                  ...
                  ye(i.exclude) && (e.exclude = i.exclude),
    ...
    return "string" == typeof e.explain && e.explain.length < 1e3 && (i.explain = e.explain),
      ...
      "boolean" == typeof e.mainPush && (i.mainPush = e.mainPush),
      i
  }
  function Ce(e, t) {
    if (!d().existsSync(e))
    ...
    if (n.location = c().dirname(e),
      ...
      if (!n.isDev || !/^(?:https?|file):\/\//i.test(i.main)) {
        const e = c().join(n.location, i.main);
        if (!e.startsWith(n.location) || !d().existsSync(e))
          throw new Error('"main" 配置文件不存在');
        i.main = (0,
          H.pathToFileURL)(e).href
      }
      n.main = i.main
    } else
      n.isTpl = !0;
    ...
    if (i.preload) {
      ...
      const e = c().join(n.location, i.preload);
      if (!e.startsWith(n.location) || !d().existsSync(e))
    ...
    const o = c().join(n.location, i.logo);
    if (!o.startsWith(n.location) || !d().existsSync(o))
      throw new Error('"logo" 配置文件不存在');
    if (i.logo = (0,
      H.pathToFileURL)(o).href,
      n.logo = i.logo,
      i.pluginSetting) {
      const e = {};
    ...
    if (n.isTpl && (n.pluginSetting.height = 1),
      O() ? n.mainPushPower = !0 : n.mainPushPower = n.isDev || "福州猿力信息科技有限公司" === n.author,
      ...
      i.features.forEach((e => {
        ...
        if (t) {
          if (t.icon && !(t.icon.startsWith("dbicon://") || n.isDev && t.icon.startsWith("file://"))) {
            ...
            /\.(?:png|svg|jpg|jpeg)$/i.test(t.icon) && e.startsWith(n.location) && d().existsSync(e) ? t.icon = (0,
              H.pathToFileURL)(e).href : delete t.icon
          }
  ...
  const ve = require("events");
  var Se = e.n(ve);
  const We = require("rimraf");
  function Pe(e, t, i) {
    return (t = function(e) {
      var t = function(e, t) {
  ...
  class De extends (Se()) {
    constructor(e, i, n, o, s) {
      super(),
        Pe(this, "setPluginDirName", ((e, i, n, o, s) => {
          let r;
          const a = c().join(this.userPluginsPath, "install");
          if (d().existsSync(a)) {
            const e = F(d().readFileSync(a, "utf8"));
            e && (r = JSON.parse(e))
          }
          r || (r = {}),
            i ? r[e] = {
          ...
          try {
            d().writeFileSync(a, M(JSON.stringify(r)), {
              encoding: "utf8"
            })
          } catch (e) {
            new t.Notification({
        ...
        Pe(this, "setPluginDirNameIllegal", (e => {
          let t;
          const i = c().join(this.userPluginsPath, "install");
          if (d().existsSync(i)) {
            const e = F(d().readFileSync(i, "utf8"));
            e && (t = JSON.parse(e))
          }
          if (!t)
            return;
          ...
          if (n) {
            if ("object" == typeof n)
              ...
              try {
                const i = f().lstatSync(c().join(this.userPluginsPath, n + ".asar"));
                t[e] = {
                  dirName: n,
                  mtimeMs: i.mtimeMs,
                  illegal: !0
        ...
        Pe(this, "apiServiceCheckUpdate", (e => {
          const t = this.accountCmp.getAccountToken();
          G(this.config.checkUpdateURL + (t ? "?access_token=" + t : ""), {
            ...
            */
            e.message_badge_id && R() && this.emit("message_badge", String(e.message_badge_id))
          }
          )).catch((e => {
        ...
        Pe(this, "currentDayCDNCheckUpdate", (e => {
          ...
          i.setHeader("Cache-Control", "no-store"),
            i.on("response", (t => {
              ...
              t.on("data", (t => {
                ...
                i ? e.forEach((e => {
                  const t = i[e.name];
                  t && ie().gt(t, e.version) && e.name in this.pluginContainer && !this.pluginUpdateSet.includes(e.name) && this.pluginUpdateSet.push(e.name)
                }
        ...
        Pe(this, "checkUpdate", (() => {
          ...
          if (e.length > 0)
            if (this._cdnCheckUpdateCache) {
              ...
              this.apiServiceCheckUpdate(e);
          setTimeout(this.checkUpdate, T(6e5, 18e5))
        }
        )),
        Pe(this, "testPluginJsonFile", ((e, t) => {
          Ce(e, t)
        }
        )),
        Pe(this, "ffffffffServices", {
    ...
    init() {
      ...
      if (d().existsSync(i)) {
        ...
        if (n) {
          ...
          let o;
          try {
            o = d().readdirSync(this.userPluginsPath)
          } catch (e) {
    ...
    mount(e, t) {
      ...
      try {
        ...
        if (n.updateTime = e.updateTime,
          ...
          n.name in this.pluginContainer && ie().lt(n.version, this.pluginContainer[n.name].version))
          throw new Error("已存在版本 " + this.pluginContainer[n.name].version);
        return this.pluginContainer[n.name] = n,
    ...
    _install(e, i, n, o) {
      const s = d().createReadStream(i)
        , r = c().join(t.app.getPath("temp"), _() + ".asar")
        , a = f().createWriteStream(r)
        , l = ee().createGunzip();
      s.pipe(l).on("error", (() => o(new Error("安装包解压错误")))).pipe(a).on("error", (() => o(new Error("解压写入错误")))).on("finish", (() => {
        ...
        let i = null;
        try {
          i = JSON.parse(d().readFileSync(t, "utf8"))
        } catch (e) {
        ...
        let a = Y().listPackage(r).find((e => e.endsWith(".node"))) ? "*.node" : "";
        if (i.unpack && (a = a ? `@(${i.unpack}|${a})` : i.unpack),
          ...
          const t = e + ".asar";
          Y().createPackageWithOptions(e + "/", t, {
            unpack: a
          }).then((() => {
            try {
              We.rimraf.sync(e)
            ...
            if (i instanceof Error) {
              try {
                f().unlinkSync(t),
                  d().existsSync(t + ".unpacked") && We.rimraf.sync(t + ".unpacked")
              } catch { }
              o(i)
            } else
              k(t).then((e => {
                try {
                  const r = f().lstatSync(t);
    ...
    _hashFile(e, t) {
      return new Promise(((i, n) => {
        const o = p().createHash(t);
        o.on("error", n).setEncoding("hex"),
          d().createReadStream(e, {
            highWaterMark: 1048576
          }).on("error", n).on("end", (() => {
            o.end(),
              i(o.read())
    ...
    install(e, t, i) {
      ...
      e ? Q(this.config.hashURL.replace("{query}", e)).then((n => {
        ...
        i(new Error("获取 HASH 失败，" + e.message + (e.message.includes("net::ERR_FAILED") ? " 可重启软件，再次尝试!" : "")))
      }
    ...
    setFeature(e, t, i) {
      ...
      const n = this.pluginContainer[e]
        , o = be(t);
      return !!o && (e && o.icon && (o.icon.startsWith("dbicon://") || n.isDev && o.icon.startsWith("file://") || (/\.(?:png|svg|jpg|jpeg)$/i.test(o.icon) && d().existsSync(c().join(n.location, o.icon)) ? o.icon = (0,
        H.pathToFileURL)(c().join(n.location, o.icon)).href : delete o.icon)),
        i && (o.dynamic = !0),
    ...
    disableCmd(e, t, i, n) {
      ...
      if (!s || s.dynamic)
        return;
      const r = p().createHash("md5").update((e || "/") + t + i + n).digest("hex")
  ...
  class _e {
    ...
    setNativeWorkWindowInfo() {
      if (this.isMacOs && !this.isHadPrivilege) {
        if (!v().isHadPrivilege())
          return void v().requestPrivilege();
        this.isHadPrivilege = !0
      }
      this.nativeWorkWindowInfo = v().getNativeWorkWindow(),
    ...
    _showLogic(e) {
      this.forceLoginUse() || this.mainWindow.isVisible() || (e || this.setNativeWorkWindowInfo(),
        this.isWindow ? !this.nativeWorkWindowInfo || 0 !== this.nativeWorkWindowInfo.width && 0 !== this.nativeWorkWindowInfo.height ? v().focusShowWindow(this.mainWindowNativeWindowHandle, (() => {
          ...
          this.mainWindow.setBounds(this.mainWindowBounds)) : this.isMacOs ? (this.mainWindowShowTimestamp = Date.now(),
            ...
            v().focusShowWindow(this.mainWindowNativeWindowHandle),
    ...
    hide(e = !0) {
      if (this.mainWindow.isVisible())
        return this.isWindow && this.mainWindow.isFocused() ? (this.mainWindowBlurTimestamp = Date.now(),
          ...
          void (e && this.nativeWorkWindowInfo && v().restorePrevWindowFocus(this.nativeWorkWindowInfo.id))) : void this.mainWindow.hide()
    }
    setHeight(e) {
  ...
  function Te() {
    return {
      goSetting: () => {
        this.autoLoadPlugin("FFFFFFFF", "settings", "个人中心", "prefercences")
      }
      ,
      goAccount: () => {
        this.autoLoadPlugin("FFFFFFFF", "settings", "个人中心", "account")
      }
      ,
      goMessageHub: e => {
        O() ? this.autoLoadPlugin("FFFFFFFF", "messagehub", "消息中心") : this.autoLoadPlugin("FFFFFFFF", "store", "插件应用市场", e ? "%" + e : void 0)
      }
      ,
      redirectPluginStore: e => {
        this.autoLoadPlugin("FFFFFFFF", "store", "插件应用市场", "#" + e)
      }
      ,
      goInstalledPluginInfo: e => {
        this.autoLoadPlugin("FFFFFFFF", "installed", "已安装应用", "/" + e)
      }
      ,
      goFindViewCmd: e => {
        this.autoLoadPlugin("FFFFFFFF", "featurecmds", "所有关键字", "&" + e)
      }
    }
  }
  const Me = {
  ...
  class Re extends (Se()) {
    ...
    getRemoteDbInfo() {
      return new Promise(((e, i) => {
        ...
        if (!n || 1 !== n.db_sync)
          return e(null);
        let o = this.config.sync;
        if (n.db_address)
          try {
            o = new URL(n.db_address)
          } catch { }
        const s = o.protocol + "//" + o.host + (o.port ? ":" + o.port : "") + "/db_" + n.uid
          , r = t.net.request({
            url: s
          });
        r.setHeader("Authorization", "Basic " + Buffer.from(n.uid + ":" + n.db_secrect_key).toString("base64")),
          r.on("response", (t => {
            const n = [];
            t.on("data", (e => {
              n.push(e)
    ...
    dbSync(e) {
      if (this.cancelDbSync(),
        this.pouchDB.name !== c().join(this.dbpath, e.uid))
  ...
  class Oe {
    constructor(e) {
      ...
      t = this,
        n = {
          showMainCmdMenu: async (e, { x: t, y: i, cmd: n, renderType: o, isFirst: s }) => {
            ...
            if (!r)
              return;
            this._cmd = n,
              this._mainCmdMenus.getMenuItemById("removeRecentCmd").visible = "recent" === o,
              this._mainCmdMenus.getMenuItemById("moveToFirst").visible = "menus" === o && !s;
            const a = this._mainCmdMenus.getMenuItemById("pinToMain")
              ...
              , d = this._mainCmdMenus.getMenuItemById("unpinFromVoice");
            "text" !== n.trueType || n.weight || r.isDev ? (a.visible = !1,
              c.visible = !1,
              l.visible = !1,
              d.visible = !1) : (await this.dbCmp.get("/", "mainmenus/" + x(n.pluginId + "/" + n.label)) ? (a.visible = !1,
                c.visible = !0) : (a.visible = !0,
                  c.visible = !1),
                this.voiceCmp.voiceWindow ? await this.dbCmp.get("/", "panelmenus/" + x(n.pluginId + "/" + n.label)) ? (l.visible = !1,
                  d.visible = !0) : (l.visible = !0,
                    d.visible = !1) : (l.visible = !1,
                      d.visible = !1)),
              this._mainCmdMenus.getMenuItemById("pluginInfo").visible = !!n.pluginId && "FFFFFFFF" !== n.pluginId && !r.isDev,
              this._mainCmdMenus.getMenuItemById("openInFolder").visible = !n.pluginId && (n.featureCode.startsWith("localopen:") || (this.windowCmp.isWindow ? /^[A-Za-z]:\\/.test(n.featureCode) : n.featureCode.startsWith("/"))),
              this.windowCmp.isWindow && (this._mainCmdMenus.getMenuItemById("administratorRun").visible = !n.pluginId && (n.featureCode.startsWith("localopen:") || /^([A-Za-z]:\\|\\\\)/.test(n.featureCode))),
              this._mainCmdMenus.popup({
        ...
        (i = function(e) {
          ...
          return "symbol" == typeof t ? t : String(t)
        }(i = "mainServices")) in t ? Object.defineProperty(t, i, {
          value: n,
          enumerable: !0,
          configurable: !0,
          writable: !0
    ...
    init() {
      ...
      t.Menu.setApplicationMenu(t.Menu.buildFromTemplate(i)),
        this.initMainCmdMenus()
    }
    initMainCmdMenus() {
      const e = [{
        id: "removeRecentCmd",
        label: '从"使用记录"中删除',
        icon: c().join(__dirname, "res", "menu", "delete-one@2x.png"),
        click: () => {
          process.nextTick((() => {
        ...
        id: "moveToFirst",
        label: "移动到顶部",
        icon: c().join(__dirname, "res", "menu", "to-left@2x.png"),
        click: () => {
          process.nextTick((() => {
            if (!this._cmd)
              return;
            ...
            this.appCmp.getMainCmdMenusDocs().then((i => {
              ...
              n && (i.splice(i.indexOf(n), 1),
                i.unshift(n),
                this.appCmp.saveMainCmdMenuSort(i).then((() => {
        ...
        id: "pinToMain",
        label: '固定到"搜索面板"',
        icon: c().join(__dirname, "res", "menu", "pin@2x.png"),
        click: () => {
          process.nextTick((() => {
            if (!this._cmd)
              return;
        ...
        id: "unpinFromMain",
        label: '从"搜索面板"取消固定',
        icon: c().join(__dirname, "res", "menu", "unpin@2x.png"),
        click: () => {
          process.nextTick((() => {
            if (!this._cmd)
              return;
        ...
        click: () => {
          process.nextTick((() => {
            if (!this._cmd)
              return;
            const { pluginId: e, label: t } = this._cmd;
            this.dbCmp.get("/", "panelmenus/" + x(e + "/" + t)).then((e => {
        ...
        id: "findViewCmd",
        label: "查看关键字",
        icon: c().join(__dirname, "res", "menu", "find@2x.png"),
        click: () => {
          process.nextTick((() => {
            if (this._cmd)
              if (this._cmd.weight) {
                const e = this.pluginsCmp.pluginContainer[this._cmd.pluginId]?.featureDic[this._cmd.featureCode]?.cmds.find((e => "base" === e.type && !e.weight && e.label.replace(/ /g, "") === this._cmd.label));
                e && this.windowCmp.ffffffff.goFindViewCmd(e.label)
              } else
                this.windowCmp.ffffffff.goFindViewCmd(this._cmd.label)
          }
          ))
        }
      }, {
        ...
        click: () => {
          process.nextTick((() => {
            this.windowCmp.ffffffff.goInstalledPluginInfo(this._cmd?.pluginId)
          }
          ))
        }
      }, {
        id: "openInFolder",
        label: "打开文件位置",
        icon: c().join(__dirname, "res", "menu", "folder-open@2x.png"),
        click: () => {
          process.nextTick((() => {
            if (!this._cmd)
              return;
            let e = this._cmd.featureCode;
            e.startsWith("localopen:") && (e = e.replace("localopen:", "")),
              e = c().normalize(e),
              this.windowCmp.hideMainWindow(!1),
              d().existsSync(e) ? t.shell.showItemInFolder(e) : new t.Notification({
                body: "文件不存在！"
              }).show()
          }
          ))
        ...
        id: "administratorRun",
        label: "以管理员身份打开",
        icon: c().join(__dirname, "res", "menu", "shield@2x.png"),
        click: () => {
          process.nextTick((() => {
            if (!this._cmd)
              return;
            ...
            e.startsWith("localopen:") && (e = e.replace("localopen:", "")),
              e = c().normalize(e),
              this.windowCmp.hideMainWindow(!1),
              d().existsSync(e) ? v().adminShellExecute(e) || t.shell.openPath(e) : new t.Notification({
                body: "文件不存在！"
              }).show()
          }
          ))
  ...
  const Le = require("electron-updater");
  class Ne {
    constructor(e, i, n) {
      var o, s, r;
      o = this,
        ...
        (s = function(e) {
          ...
          return "symbol" == typeof t ? t : String(t)
        }(s = "checkNewestVersion")) in o ? Object.defineProperty(o, s, {
          value: r,
          enumerable: !0,
          configurable: !0,
          writable: !0
    ...
    init() {
      ...
      let n = "";
      r().macOS() ? n = "res/iconTemplate@2x.png" : r().windows() ? n = parseInt(m().release()) < 10 ? "res/icon.png" : "res/icon.ico" : r().linux() && (n = "res/icon@2x.png"),
        this.tray = new t.Tray(c().join(__dirname, n));
      const o = [...R() ? [{
        label: "uTools 官网",
        click: () => {
          process.nextTick((() => {
      ...
      }, */
      {
        ...
        click: () => {
          process.nextTick((() => {
            t.shell.openExternal(this.config.redirectURL + "update_description&version=" + e)
          }
          ))
        }
      }, ...R() ? [{
    ...
    checkForUpdate() {
      ...
      if (Le.autoUpdater.listenerCount("update-available") > 0 || Le.autoUpdater.listenerCount("update-not-available") > 0)
        return;
      const e = () => {
        Le.autoUpdater.removeListener("update-available", e),
          new t.Notification({
            title: "更新检测",
        ...
        , i = () => {
          Le.autoUpdater.removeListener("update-not-available", i),
            this.config.newestVersionURL ? this.checkNewestVersion() : new t.Notification({
              title: "更新检测",
              body: "当前版本为最新版本！"
            }).show()
        }
        ;
      Le.autoUpdater.addListener("update-available", e),
        Le.autoUpdater.addListener("update-not-available", i),
        setTimeout((function() {
          Le.autoUpdater.removeListener("update-available", e),
            Le.autoUpdater.removeListener("update-not-available", i)
        }
        ), 1e4),
        Le.autoUpdater.checkForUpdates()
    }
  }
  function Ue(e, t, i) {
    return (t = function(e) {
  ...
  const He = [50, 67, 75, 80, 90, 100, 110, 125, 150, 175, 200, 250, 300];
  class je {
    constructor(e) {
    ...
    initPluginMenu() {
      const e = this.getDetachHotKey()
        , i = [{
          id: "detach@" + e,
          label: "分离为独立窗口",
          icon: c().join(__dirname, "res", "menu", "square@2x.png"),
          accelerator: e,
          click: () => {
            process.nextTick((() => {
          ...
          label: "插件应用设置",
          icon: c().join(__dirname, "res", "menu", "setting@2x.png"),
          submenu: [{
            id: "enterdetach",
            label: "自动分离为独立窗口",
            type: "checkbox",
          ...
          id: "out",
          label: "退出到后台",
          icon: c().join(__dirname, "res", "menu", "reduce-one@2x.png"),
          accelerator: "Esc",
          click: () => {
            process.nextTick((() => {
    ...
    async mainWindowShowPluginMenu() {
      ...
      const [r, a] = this.appCmp.getPluginMainPushPower(i)
        , l = this._mainPluginMenu.getMenuItemById("mainpushpower");
      l.enabled = r,
        l.checked = a;
      const d = this.getDetachHotKey()
        , u = this._mainPluginMenu.getMenuItemById("detach@" + d);
      u ? u.visible || (this._mainPluginMenu.items.filter((e => e.id && e.id.startsWith("detach@") && e.id !== d)).forEach((e => {
        e.visible = !1
      }
      )),
        u.visible = !0) : (this._mainPluginMenu.items.filter((e => e.id && e.id.startsWith("detach@"))).forEach((e => {
          e.visible = !1
        }
        )),
      ...
      const h = this.windowCmp.mainWindow.getSize()[0] - this.windowCmp.config.initHeight
        , p = this.windowCmp.isMacOs ? this.windowCmp.config.initHeight + 5 : this.windowCmp.config.initHeight;
    ...
    async buildDetachPluginOptionMenu(e, i) {
      ...
      const [s, r] = this.appCmp.getPluginMainPushPower(e);
      let a = t.Menu.buildFromTemplate([{
        label: "自动分离为独立窗口",
        type: "checkbox",
    ...
    buildDetachPluginViewZoomMenu(e, i) {
      ...
      let r = t.Menu.buildFromTemplate(He.map((e => ({
        label: e + "%",
        type: "radio",
        checked: s === e,
        click: o
  ...
  class $e {
    constructor(e) {
      ...
      i = this,
        s = {
          ...
          setShowHotKey: (e, i) => {
            if (i = I(i),
              Je.isFKey(i) && Je.isRegistered(i))
              return void (e.returnValue = !1);
            const o = n().get("showHotKey");
            o && (Je.isFKey(o) ? Je.unregister(o) : t.globalShortcut.isRegistered(o) && t.globalShortcut.unregister(o)),
              n().set("showHotKey", i),
        ...
        (o = function(e) {
          ...
          return "symbol" == typeof t ? t : String(t)
        }(o = "ffffffffServices")) in i ? Object.defineProperty(i, o, {
          value: s,
          enumerable: !0,
          configurable: !0,
          writable: !0
    ...
    init() {
      if (n().has("openAtLogin") || n().set("openAtLogin", !0),
        n().has("spaceAsEnter") || n().set("spaceAsEnter", !1),
  ...
  class Qe extends (Se()) {
      ...
      super(),
        ...
        qe(this, "ffffffffServices", {
          ...
          getLocalAccount: e => {
            ...
            if (t) {
              if (delete t.db_secrect_key,
                ...
                1 === t.type && "number" == typeof t.expired_at) {
                const e = new Date(1e3 * t.expired_at);
                e > new Date("2099-1-1") ? t.expiredAtStr = "" : t.expiredAtStr = e.toLocaleDateString("zh-Hans-CN", {
                  year: "numeric",
                  month: "2-digit",
                  day: "2-digit"
                }).replace(/\//g, "-")
          ...
          setOpenDbSync: async e => {
            const t = this.getAccountToken();
            t && (await Q(this.config.dbSyncURL, {
              access_token: t,
              sync: e ? "open" : "close"
            }),
          ...
          loginAccount: (e, t) => new Promise(((i, o) => {
            this.remoteAccountInfo(e, ((e, s) => {
              if (e)
                return o(e);
              O() && (t && "string" == typeof t ? n().set("userpass", M(t)) : n().has("userpass") && n().delete("userpass")),
                this.emit("login", s),
          ...
          logout: (e, t) => {
            this.logout(t),
              this.config.forceLogin && (this.emit("logout_message", "手动退出"),
                this.showLoginWindow()),
              e.returnValue = !0
          }
        }),
        this.config = e,
        this.machineId = v().getMachineId(),
        this.machineIdSign = v().getMachineIdSignature().toString("hex"),
        this.nativeId = v().getNativeId(),
        this.nativeIdSign = v().getNativeIdSignature().toString("hex"),
        this.remotedAccountInfoTimestamp = 0,
        G(e.muserURL + this.getAccountToken(), {
          mid: this.machineId,
    ...
    getAccountToken() {
      ...
      if ("string" == typeof t) {
        ...
        e = t.token;
      return e ? F(Buffer.from(e, "hex")) : ""
    }
    init() {
      const e = this.getAccountInfo();
      e && (e.token_expired_at ? this.accountTokenExpiredAt = 1e3 * e.token_expired_at : this.accountTokenExpiredAt = null,
        this.emit("login", e),
        setImmediate((() => {
    ...
    remoteAccountInfo(e, i) {
      const o = v().getRandomKeyAndSignature();
      Q(this.config.profileURL, {
        access_token: e,
        mid: this.machineId,
        mids: this.machineIdSign,
        nid: this.nativeId,
        ...
        const s = o.timestamp
          , r = o.sign
          , a = o.user_info;
        if (v().compareServerSignature(a + s, Buffer.from(r, "hex"))) {
          ...
          c.token_expired_at ? this.accountTokenExpiredAt = 1e3 * c.token_expired_at : this.accountTokenExpiredAt = null,
            o && o.db_sync !== c.db_sync && (c.db_sync ? this.emit("dbsync", c) : (this.emit("undbsync", c),
              new t.Notification({
                title: "数据同步关闭",
                body: "当前账号数据同步功能已关闭!"
              }).show())),
            "function" == typeof i && i(null, c)
        } else
          setTimeout((() => {
            this.logout(),
              this.emit("logout_message", "检测到账号信息非法签名，已退出账号！")
          }
          )),
        ...
        401 === e.code && n().has("account") && setTimeout((() => {
          this.logout(),
            this.emit("logout_message", "账号密钥已失效，已退出账号！")
        }
        )),
    ...
    loopRemoteAccountInfo() {
      this.loopRemoteAccountInfoTimer = setTimeout((() => {
        if (!this.config.forceLogin && Date.now() - this.remotedAccountInfoTimestamp < 432e5)
    ...
    pingAccessTokenValid() {
      this.config.forceLogin && Q(this.config.tokenValidURL, {
        access_token: this.getAccountToken()
      }).then((e => {
        e.valid || (this.logout(),
          this.emit("logout_message", "access_token 已无效"),
          this.showLoginWindow())
      }
      ))
    }
    showLoginWindow() {
      if (this._loginWindow)
        return void this._loginWindow?.show();
      this._windowLoginSession || (this._windowLoginSession = t.session.fromPartition("login@" + Date.now()),
        this._windowLoginSession.webRequest.onResponseStarted({
          urls: [this.config.apiHost + "/*"]
        }, (e => {
          const i = e.responseHeaders["access-token"] || e.responseHeaders["Access-Token"];
          i && this.remoteAccountInfo(i[0], (async (e, i) => {
            const o = this._loginWindow.webContents.getURL();
            if (this._loginWindow && this._loginWindow.destroy(),
              e)
              return void new t.Notification({
                title: "登录异常",
                body: e.message
            ...
            let s;
            if (o.startsWith("file://") && (0,
              H.fileURLToPath)(o).startsWith(__dirname) && o.includes("#")) {
              try {
                s = JSON.parse(decodeURIComponent(o.split("#")[1]))
              } catch { }
              s && s.username && s.password && n().set("userpass", M(JSON.stringify(s)))
            }
            !s && n().has("userpass") && n().delete("userpass"),
              this.emit("login", i),
              this.loopRemoteAccountInfoTimer && clearTimeout(this.loopRemoteAccountInfoTimer),
              this.loopRemoteAccountInfo()
          }
      ...
      const { width: e, height: i, url: o } = this.config.forceLogin;
      this._loginWindow = new t.BrowserWindow({
        alwaysOnTop: !0,
        resizable: !1,
        fullscreenable: !1,
        minimizable: !1,
        ...
        this._loginWindow.once("closed", (() => {
          this._loginWindow = null,
            this._windowLoginedCallback = null
        }
        )),
        o && /^https?:\/\//i.test(o) ? this._loginWindow.loadURL(o) : this._loginWindow.loadFile(c().join(__dirname, "login", o), {
          query: {
    ...
    isLogined() {
      return !(!n().has("account") || this.accountTokenExpiredAt && this.accountTokenExpiredAt < Date.now() && (this.logout(),
        this.emit("logout_message", "token 过期"),
        1))
    }
  }
  function Ge(e, t, i) {
  ...
  class Ze extends (Se()) {
    constructor(e, i) {
      super(),
        Ge(this, "clipboardPluginId", "clipboard"),
        Ge(this, "autoPasteLife", 5),
        Ge(this, "updateTimestamp", 0),
        Ge(this, "cancelWatchTimeout", null),
        Ge(this, "maxRecordNum", 1e3),
        Ge(this, "maxGroupRecordNum", 100),
        Ge(this, "getRecordFolderNames", (() => {
          if (!f().existsSync(this.clipboardDataDir))
            return [];
          let e;
          try {
            e = f().readdirSync(this.clipboardDataDir)
          } catch {
            return null
          }
          if (0 === e.length)
          ...
          if (e.length > i.length) {
            const t = e.filter((e => !i.includes(e))).map((e => c().join(this.clipboardDataDir, e)));
            (0,
              We.rimraf)(t)
          }
          return i
        ...
        Ge(this, "initCurrentRecordFileStat", (() => {
          do {
            try {
              ...
              if (!f().existsSync(i))
                break;
              let n = f().readFileSync(i, "utf-8").split("\n").length;
        ...
        Ge(this, "appendRecordItem", (e => {
          ...
          if (this._prevRecordItemHash = e.hash,
            ...
            try {
              f().mkdirSync(this.currentRecordFileStat.folder, {
                recursive: !0
              })
            } catch {
              return
          ...
          if ("image" === e.type) {
            this._currentClipboardImageRecordCache = {
              key: v().getClipboardChangeCount(),
              buffer: e.buffer
            };
            const t = c().join(this.currentRecordFileStat.folder, e.hash);
            try {
              f().existsSync(t) || f().writeFileSync(t, e.buffer)
            } catch { }
            delete e.buffer
          }
          try {
            const t = M(JSON.stringify(e));
            f().appendFileSync(c().join(this.currentRecordFileStat.folder, "data"), t + "\n", "utf-8")
          } catch {
            return
          }
        ...
        Ge(this, "getRecordItem", (() => new Promise((e => {
          const i = Date.now()
            , n = this.getCopyFiles();
          if (n) {
            const t = p().createHash("md5").update(JSON.stringify(n)).digest("hex");
            return e({
              type: "files",
              value: n,
              timestamp: i,
          ...
          if ("text/plain" === o[0]) {
            ...
            if (n.trim()) {
              const t = p().createHash("md5").update(n).digest("hex");
              return e({
                type: "text",
                value: n,
                timestamp: i,
          ...
          if (r().linux()) {
            ...
            if (n.isEmpty())
              return e(null);
            const o = n.toPNG()
              , s = p().createHash("md5").update(o).digest("hex");
            return e({
              type: "image",
              size: o.byteLength,
              timestamp: i,
          ...
          v().readClipboardImage((n => {
            ...
            const o = p().createHash("md5").update(n).digest("hex");
            e({
              type: "image",
              size: n.byteLength,
              timestamp: i,
        ...
        Ge(this, "clipboardServices", {
          readAllRecords: () => new Promise(((e, t) => {
            ...
            for (const t of i) {
              ...
              if (!f().existsSync(i)) {
                (0,
                  We.rimraf)(c().join(this.clipboardDataDir, t));
                continue
              }
              let s;
              try {
                s = f().readFileSync(i, "utf-8")
              } catch {
                continue
              }
              const r = s.split("\n").reverse();
              for (const i of r) {
                ...
                if (!(r.hash in n) && ("image" === r.type && (r.value = c().join(this.clipboardDataDir, t, r.hash)),
                  n[r.hash] = r,
                  ++o >= this.maxRecordNum))
          ...
          clearAllRecords: async () => {
            ...
            try {
              await (0,
                We.rimraf)(this.clipboardDataDir)
            } catch {
              if (!f().existsSync(this.clipboardDataDir))
                return;
              const e = f().readdirSync(this.clipboardDataDir);
              if (0 === e.length)
                return;
              e.filter((e => /^\d{13}$/.test(e))).forEach((e => {
                const t = c().join(this.clipboardDataDir, e, "data");
                try {
                  f().existsSync(t) && f().writeFileSync(t, "")
                } catch { }
              }
              ))
            }
          ...
          removeRecords: async e => {
            const t = this.getRecordFolderNames().map((e => parseInt(e)))
              , i = {};
            for (const n of e) {
              if (!n)
                continue;
            ...
            for (const e in i) {
              const t = c().join(this.clipboardDataDir, e)
                , n = c().join(t, "data");
              if (!f().existsSync(n))
                continue;
              let o;
              try {
                o = f().readFileSync(n, "utf-8")
              } catch {
                continue
              }
              const s = i[e];
        ...
        Ge(this, "mainServices", {
          ...
          getClipboardImage: e => {
            if (this._currentClipboardImageRecordCache) {
              let t;
              if (this._currentClipboardImageRecordCache.key === v().getClipboardChangeCount() && (t = this._currentClipboardImageRecordCache.buffer),
  ...
  const Xe = require("vm");
  var Ye = e.n(Xe);
  const ze = require("child_process");
  var et = e.n(ze);
  const tt = require("new-ubrowser-client");
  var it = e.n(tt);
  const nt = {
    "iPhone 11": {
      size: {
  ...
  class st {
      ...
      e = this,
        n = (e, i) => {
          const n = r().macOS()
            , o = [{
              label: "返回",
              icon: c().join(__dirname, "res", "menu", "arrow-left@2x.png"),
              ...
              label: "前进",
              icon: c().join(__dirname, "res", "menu", "arrow-right@2x.png"),
              ...
              label: "刷新",
              icon: c().join(__dirname, "res", "menu", "refresh@2x.png"),
              ...
              label: "复制网页地址",
              icon: c().join(__dirname, "res", "menu", "copy-link@2x.png"),
              click: () => {
                t.clipboard.writeText(this._browserWindow.webContents.getURL())
              }
            }, {
              label: "浏览器中打开网页",
              icon: c().join(__dirname, "res", "menu", "browser-chrome@2x.png"),
              click: () => {
                t.shell.openExternal(this._browserWindow.webContents.getURL())
              }
            }, {
              label: "网页窗口截图",
              icon: c().join(__dirname, "res", "menu", "screenshot@2x.png"),
              click: () => {
                this._browserWindow.webContents.capturePage().then((e => {
                  try {
                    const i = c().join(r().windows() ? v().getDownloadsFolderPath() : t.app.getPath("downloads"), Date.now() + ".png");
                    d().writeFileSync(i, e.toPNG()),
          ...
          i.linkURL && (o.push({
            ...
            o.push({
              label: "复制链接地址",
              icon: c().join(__dirname, "res", "menu", "link@2x.png"),
              click: () => {
            ...
            "image" === i.mediaType && (o.push({
              type: "separator"
            }),
              o.push({
                label: "下载图片",
                icon: c().join(__dirname, "res", "menu", "down-picture@2x.png"),
                click: () => {
            ...
            i.isEditable ? (o.push({
              ...
              })) : i.selectionText && (o.push({
                type: "separator"
              }),
                o.push({
                  label: "复制",
                  accelerator: n ? "Command+C" : "Ctrl+C",
                  icon: c().join(__dirname, "res", "menu", "copy@2x.png"),
                  click: () => {
        ...
        (i = function(e) {
          ...
          return "symbol" == typeof t ? t : String(t)
        }(i = "handleContextMenu")) in e ? Object.defineProperty(e, i, {
          value: n,
          enumerable: !0,
          configurable: !0,
          writable: !0
    ...
    async press(e, ...t) {
      if (!this._pageIsDomReadyed)
        throw new Error('"goto" method dit not executed');
      ot || (ot = Object.values(Ie));
      const i = String(e).toLowerCase();
      let n = ot.find((e => e.toLowerCase() === i));
      if (!n)
        throw new Error("keyCode error");
      if ("Enter" === n ? n = String.fromCharCode(13) : "Space" === n && (n = String.fromCharCode(32)),
        t.length > 0 && (t = Array.from(new Set(t)).map((e => String(e).toLowerCase()))).find((e => !["shift", "ctrl", "alt", "meta"].includes(e))))
    ...
    async capture(e, i) {
      ...
      const r = c().join(n, o || Date.now() + ".png");
      return d().writeFileSync(r, s.toPNG()),
        r
    }
    ...
    async pdf(...e) {
      ...
      if (1 === e.length ? "object" == typeof e[0] ? o = e[0] || {} : "string" == typeof e[0] && (s = e[0]) : e.length > 1 && ("object" == typeof e[0] && (o = e[0] || {}),
        ...
        s) {
        if (/\.pdf$/i.test(s) ? (i = c().dirname(s),
          n = c().basename(s)) : i = s,
          !d().existsSync(i))
          throw new Error("save directory not exist")
      } else
        i = c().join(t.app.getPath("temp"), "utools-ubrowser"),
          d().existsSync(i) || d().mkdirSync(i);
      const r = await this._browserWindow.webContents.printToPDF(o)
        , a = c().join(i, n || Date.now() + ".pdf");
      return d().writeFileSync(a, r),
        a
    }
    async download(e, i) {
      if (!this._pageIsDomReadyed)
      ...
      return await new Promise(((n, o) => {
        this._browserWindow.webContents.session.removeAllListeners("will-download"),
          this._browserWindow.webContents.session.once("will-download", ((e, s, r) => {
            if (i)
              try {
                if (d().existsSync(i)) {
                  if (!d().lstatSync(i).isDirectory())
                    throw new Error('"' + i + '" existed');
                  if (i = c().join(i, s.getFilename()),
                    d().existsSync(i))
                    throw new Error('"' + i + '" existed')
                } else {
                  const e = c().dirname(i);
                  if (!d().existsSync(e) || !d().lstatSync(e).isDirectory())
                    throw new Error('save directory "' + e + '" no exist');
                  c().extname(i) || (i += c().extname(s.getFilename()))
                }
              } catch (t) {
              ...
              const n = c().join(t.app.getPath("temp"), "utools-ubrowser", "download_" + Date.now());
              try {
                d().mkdirSync(n, {
                  recursive: !0
                })
      ...
      return new Promise(((l, d) => {
        if ("number" == typeof n) {
          ...
          if (!i || i.isDestroyed() || !i.isVisible() || i.webContents.session !== s.pluginUBrowserSessionPool[e])
            return d(new Error('no ubrowser with id "' + n + '" existed'));
          const o = a.indexOf(n);
          o >= 0 && a.splice(o, 1),
            this._browserWindow = i
        } else if (!o.find((e => "goto" === e.method)))
          return d(new Error('"goto" not executed'));
        if (this._browserWindow)
          ...
          this._browserWindow.webContents.once("destroyed", (() => {
            this._isEnd || (this._childProcess.kill("SIGKILL"),
              d(new Error("ubrowser is closed")));
            const e = a.indexOf(o);
            e >= 0 && a.splice(e, 1)
          }
          )),
            ...
            r().macOS() ? this._browserWindow.webContents.on("before-input-event", ((e, t) => {
              if (t.meta && "keyDown" === t.type && !t.control && !t.alt && !t.shift)
                return "KeyW" === t.code || "KeyQ" === t.code ? (e.preventDefault(),
                  void this._browserWindow.destroy()) : "KeyR" === t.code ? (e.preventDefault(),
                    void this._browserWindow.webContents.reloadIgnoringCache()) : "BracketLeft" === t.code ? (e.preventDefault(),
                      void (this._browserWindow.webContents.canGoBack() && this._browserWindow.webContents.goBack())) : void ("BracketRight" === t.code && (e.preventDefault(),
                        this._browserWindow.webContents.canGoForward() && this._browserWindow.webContents.goForward()))
            }
              ...
              if ("keyDown" === t.type && !t.shift) {
                if (t.control) {
                  if (t.alt)
                    return;
                  return "KeyW" === t.code ? (e.preventDefault(),
                    void this._browserWindow.destroy()) : void ("KeyR" === t.code && (e.preventDefault(),
                      this._browserWindow.webContents.reloadIgnoringCache()))
                }
                if (t.alt) {
                  if ("F4" === t.code)
                    return e.preventDefault(),
                      void this._browserWindow.destroy();
                  if ("ArrowLeft" === t.code)
                    return e.preventDefault(),
                      void (this._browserWindow.webContents.canGoBack() && this._browserWindow.webContents.goBack());
                  "ArrowRight" === t.code && (e.preventDefault(),
                    this._browserWindow.webContents.canGoForward() && this._browserWindow.webContents.goForward())
                }
              }
            }
            ...
            this._browserWindow.webContents.on("context-menu", this.handleContextMenu)
        }
        this._childProcess = et().fork(c().join(__dirname, "ubrowser", "runner.js")),
            ...
            if ("run" !== e)
              if ("runEnd" === e) {
                ...
                this._isShow ? (e.data?.push({
                  ...
                  a.push(this._browserWindow.id)) : this._browserWindow.destroy(),
                  l(e)
              } else {
                const n = this[e];
  ...
  class ct {
    constructor(e, i, o, s, a, l, u, h) {
      rt(this, "createMainCmdMenu", (async (e, t, i) => {
        this.mainCmdMenusDocsCache = null;
        const n = "mainmenus/" + x(e + "/" + i);
        ...
        rt(this, "saveMainCmdMenuSort", (async e => {
          this.mainCmdMenusDocsCache = e;
          let t = await this.dbCmp.get("/", "mainmenusort");
          if (t) {
            if (0 === e.length)
              return void await this.dbCmp.remove("/", t)
          } else
            t = {
              _id: "mainmenusort"
            };
        ...
        rt(this, "removeMainCmdMenu", (async (e, t) => {
          const i = await this.dbCmp.get("/", "mainmenus/" + x(e + "/" + t));
          if (!i)
            return;
          this.mainCmdMenusDocsCache = null,
            await this.dbCmp.remove("/", i);
          const n = await this.getMainCmdMenusDocs();
          await this.saveMainCmdMenuSort(n)
        }
        )),
        rt(this, "getMainCmdMenusDocs", (async () => {
        ...
        rt(this, "runUBrowser", (async (e, { options: t, queue: i }) => {
          const n = H.fileURLToPath(this.pluginsCmp.pluginContainer[e]?.logo);
          return await (new st).run({
            pluginId: e,
            pluginLogo: n,
            options: t,
            queue: i,
        ...
        rt(this, "runUBrowserByScript", (async (e, t) => {
          if (!this._runUBrowserByScriptContext) {
            ...
            this._runUBrowserByScriptContext = {
              ...
              Ye().createContext(this._runUBrowserByScriptContext)
          }
          return await Promise.resolve(Ye().runInContext(t, this._runUBrowserByScriptContext))
        }
        )),
        ...
        rt(this, "ffffffffServices", {
          ...
          getResIconAbsolutePath: (e, t) => {
            e.returnValue = c().join(__dirname, t)
          }
          ,
          ...
          getLocalOpenFeatures: async e => {
            ...
            const i = t.files.map((e => f().existsSync(e) ? this.convertLocalOpenFeature(e) : {
              code: at + e,
              explain: e,
          ...
          ,
          createMainCmdMenu: this.createMainCmdMenu,
          getMainCmdMenu: async (e, t, i) => {
            const n = await this.dbCmp.get("/", "mainmenus/" + x(t + "/" + i));
            e.returnValue = n
          }
          ,
          removeMainCmdMenu: async e => {
            e._id?.startsWith("mainmenus/") && (this.mainCmdMenusDocsCache = null,
              await this.dbCmp.remove("/", e))
          }
          ,
          getPluginMenuSetting: async (e, t) => {
            ...
            const o = this.pluginIsEnterDetach(t)
              , [s, r] = this.getPluginMainPushPower(t);
            e.returnValue = {
              enterDetach: o,
              outKill: i,
              runAtAppOpen: n,
          ...
          setPluginMainPushPower: async (e, t, i) => {
            await this.setPluginMainPushPower(t, i),
              e.returnValue = !0
          }
          ,
        ...
        rt(this, "pluginApiServices", {
          ...
          ,
          getLocalId: (e, t) => {
            e.returnValue = p().createHash("md5").update(this.accountCmp.machineId + t).digest("hex")
          }
          ,
          getNativeId: (e, t) => {
            e.returnValue = p().createHash("md5").update(this.accountCmp.nativeId + t).digest("hex")
          }
          ,
          screenColorPick: e => {
            let i = !1;
          ...
          ubrowserLogin: async e => {
            if (R())
              throw new Error("企业版专用 API");
            const i = this.accountCmp.getAccountInfo();
            if (!i)
              throw new Error('未登录 "' + t.app.name + '"');
            if (!i.login_script)
              throw new Error("无登录脚本");
            const n = this.accountCmp.getUserpass();
            if (!n)
              throw new Error("本地未记录登录账号密码");
            let o = i.login_script;
            for (const e in n)
              o = o.replace(`"{{${e}}}"`, JSON.stringify(n[e]));
            return await this.runUBrowserByScript(e, o)
          }
          ,
          reportInfo: (e, t, i) => {
            R() ? e.returnValue = new Error("企业版专用 API") : i && "object" == typeof i ? Buffer.byteLength(JSON.stringify(i)) > 102400 ? e.returnValue = new Error("上报数据量不能超过 100 KB") : (i.pluginId = t,
              this.reportCmp.info("plugin.report", i),
              e.returnValue = !0) : e.returnValue = new Error("参数错误")
          }
          ,
          reportExceptionError: (e, t, i) => {
            ...
            !n || n.isDev || n.unsafe || this.reportCmp.info("plugin.exception", {
              ...
              error: i.replaceAll((0,
                H.pathToFileURL)(n.location), "").replaceAll(n.location, "")
            })
          }
        }),
        rt(this, "pluginUtilApiServices", {
          isDev: e => {
          ...
          getUser: e => {
            const t = this.accountCmp.getAccountInfo();
            if (t)
              return O() ? (this.accountCmp.pingAccessTokenValid(),
                void (t.extend ? e.returnValue = {
                  avatar: t.avatar,
                  ...t.extend
                } : e.returnValue = {
                  avatar: t.avatar,
          ...
          getPath: (e, i) => {
            if ("downloads" === i && this.windowCmp.isWindow)
              e.returnValue = v().getDownloadsFolderPath();
            else
              try {
          ...
          copyImage: (e, { img: i, isRecord: n }) => {
            if (!i)
              return void (e.returnValue = !1);
            let o;
            "string" == typeof i ? /^data:image\/([a-z]+);base64,/.test(i) ? o = t.nativeImage.createFromDataURL(i) : c().basename(i) !== i && d().existsSync(i) && (o = t.nativeImage.createFromPath(i)) : "object" == typeof i && i instanceof Uint8Array && (o = t.nativeImage.createFromBuffer(Buffer.from(i))),
          ...
          copyText: (e, { text: i, isRecord: n }) => {
            "string" == typeof i ? (n || this.clipboardCmp.temporaryCancelWatch(),
          ...
          hideMainWindowPasteFile: (e, i) => {
            ...
            n && n !== this.windowCmp.mainWindow && n.isFocused() ? e.returnValue = !1 : i ? (Array.isArray(i) || (i = [i]),
              0 !== (i = i.filter((e => d().existsSync(e)))).length ? (this.windowCmp.hideMainWindow(!0),
                this.clipboardCmp.temporaryCancelWatch(),
                v().copyFile.apply(null, i),
                setTimeout((() => {
                  v().simulateKeyboardTap("v", this.windowCmp.isMacOs ? "command" : "ctrl")
                }
                ), 50),
                e.returnValue = !0) : e.returnValue = !1) : e.returnValue = !1
          }
          ...
          hideMainWindowPasteImage: (e, i) => {
            const n = t.BrowserWindow.fromWebContents(e.sender);
            if (n && n !== this.windowCmp.mainWindow && n.isFocused())
              return void (e.returnValue = !1);
            if (!i)
              return void (e.returnValue = !1);
            let o;
            "string" == typeof i ? /^data:image\/([a-z]+);base64,/.test(i) ? o = t.nativeImage.createFromDataURL(i) : c().basename(i) !== i && d().existsSync(i) && (o = t.nativeImage.createFromPath(i)) : "object" == typeof i && i instanceof Uint8Array && (o = t.nativeImage.createFromBuffer(Buffer.from(i))),
              o && !o.isEmpty() ? (this.windowCmp.hideMainWindow(!0),
                this.clipboardCmp.temporaryCancelWatch(),
                t.clipboard.writeImage(o),
                setTimeout((() => {
                  v().simulateKeyboardTap("v", this.windowCmp.isMacOs ? "command" : "ctrl")
          ...
          hideMainWindowPasteText: (e, i) => {
            const n = t.BrowserWindow.fromWebContents(e.sender);
            n && n !== this.windowCmp.mainWindow && n.isFocused() ? e.returnValue = !1 : "string" == typeof i ? (this.windowCmp.hideMainWindow(!0),
              this.clipboardCmp.temporaryCancelWatch(),
          ...
          hideMainWindowTypeString: (e, i) => {
            ...
            n && n !== this.windowCmp.mainWindow && n.isFocused() ? e.returnValue = !1 : "string" == typeof i ? (this.windowCmp.hideMainWindow(!0),
              i && (this.windowCmp.isLinux ? (this.clipboardCmp.temporaryCancelWatch(),
                t.clipboard.writeText(i),
                setTimeout((() => {
                  v().simulateKeyboardTap("v", "ctrl")
                }
                ), 50)) : [...(new Intl.Segmenter).segment(i)].forEach((e => {
                  "\n" === e.segment ? v().simulateKeyboardTap("enter", "shift") : v().unicodeType(e.segment)
                }
                ))),
              e.returnValue = !0) : e.returnValue = !1
          }
          ...
          startDrag: (e, i) => {
            ...
            if ("string" == typeof i) {
              ...
              if (!(Array.isArray(i) && i.length > 0))
                return;
              {
                const e = i.filter((e => f().existsSync(e)));
                if (0 === e.length)
                  return;
                n.files = e
              }
          ...
          shellShowItemInFolder: (e, i) => {
            i && "string" == typeof i ? (this.windowCmp.hideMainWindow(!1),
              t.shell.showItemInFolder(c().normalize(i)),
              e.returnValue = !0) : e.returnValue = !1
          }
          ,
          shellTrashItem: async e => {
            ...
            await t.shell.trashItem(c().normalize(e))
          }
          ,
          shellOpenPath: (e, i) => {
            i && "string" == typeof i ? (this.windowCmp.hideMainWindow(!1),
              t.shell.openPath(c().normalize(i)),
              e.returnValue = !0) : e.returnValue = !1
          }
          ,
          shellBeep: e => {
          ...
          simulateKeyboardTap: (e, { key: t, modifier: i }) => {
            ...
            i && Array.isArray(i) && i.length > 0 && i.forEach((e => {
              ...
              v().simulateKeyboardTap.apply(null, n),
              e.returnValue = !0
          }
          ,
          simulateMouseClick: (e, t) => {
            t ? v().simulateMouseClick(t.x, t.y) : v().simulateMouseClick(),
              e.returnValue = !0
          }
          ,
          simulateMouseRightClick: (e, t) => {
            t ? v().simulateMouseRightClick(t.x, t.y) : v().simulateMouseRightClick(),
              e.returnValue = !0
          }
          ,
          simulateMouseDoubleClick: (e, t) => {
            t ? v().simulateMouseDoubleClick(t.x, t.y) : v().simulateMouseDoubleClick(),
              e.returnValue = !0
          }
          ,
          simulateMouseMove: (e, t) => {
            t ? (v().simulateMouseMove(t.x, t.y),
              e.returnValue = !0) : e.returnValue = !1
          }
          ,
        ...
        this.dbCmp = a,
        this.screencaptureCmp = l,
        this.screencolorpickerCmp = u,
        this.helpbootCmp = h,
      ...
      this.initGlobalEvent(),
        ...
        this.dbCmp.on("pull", (e => {
          ...
          i.length > 0 && i.forEach((e => {
            ...
            e.find((e => ["outkillplugin", "enterdetachplugin", "mainpushpower"].includes(e._id))) && (e.find((e => "outkillplugin" === e._id)) && this.initOutKillPluginDoc(),
              e.find((e => "enterdetachplugin" === e._id)) && this.initEnterDetachPluginDoc(),
              e.find((e => "mainpushpower" === e._id)) && this.initMainPushPowerDoc()),
            this.mainCmdMenusDocsCache && e.find((e => e._id.startsWith("mainmenus/"))) && (this.mainCmdMenusDocsCache = null)
        }
        )),
    ...
    appFirstRun(e) {
      ...
      O() || t.net.online && setImmediate((async () => {
        ...
        const n = `ubrowser.goto(${JSON.stringify(this.config.redirectURL + "update_description&version=" + i)}).run({ width: 980, height: 720 })`;
        this.runUBrowserByScript("FFFFFFFF", n)
      }
      ))
    }
    initGlobalEvent() {
      t.app.on("exit", (() => {
        this._exitApp || (this._exitApp = !0,
          ...
          this.windowCmp.isLinux || v().stopClipboardWatch(),
          v().stopVoicePanelTriggerEvent(),
          v().stopFKeyTapEvent(),
          t.globalShortcut.unregisterAll(),
          this.windowCmp.isMacOs && (v().panelRestoreToWindow(this.windowCmp.mainWindow.getNativeWindowHandle()),
            this.voiceCmp.voiceWindow && v().panelRestoreToWindow(this.voiceCmp.voiceWindow.getNativeWindowHandle()),
            t.app.dock.hide(),
            t.app.hide()),
          setTimeout((() => {
            t.webContents.getAllWebContents().forEach((e => {
              ...
              this.windowCmp.isWindow ? v().exit() : t.app.exit()
          }
          ), 300))
      }
      )),
    ...
    setPluginFeature(e, { code: t, cmds: i, explain: n, icon: o, platform: s, mainPush: r }) {
      ...
      return a && o && o.startsWith("dbicon://") && this.windowCmp.removeDbIconCache("feature/" + e + "/" + t),
        a
    }
    ...
    async saveFeature(e, i) {
      ...
      if (void 0 !== i.mainPush) {
        if ("boolean" != typeof i.mainPush)
          throw new Error("feature mainPush error");
      ...
      if (i.icon && "string" == typeof i.icon)
        if (i.icon.startsWith("data:image/")) {
          ...
          d().existsSync(c().join(this.pluginsCmp.pluginContainer[e].location, i.icon)) ? n.icon = i.icon : delete i.icon;
      else
        delete i.icon;
    ...
    async setPluginMainPushPower(e, t) {
      ...
      i && "boolean" == typeof t && (t === i.mainPushPower ? (delete this.mainPushPowerDoc.data[e],
        0 === Object.keys(this.mainPushPowerDoc.data).length && (this.mainPushPowerDoc._deleted = !0)) : this.mainPushPowerDoc.data[e] = t,
        await this.dbCmp.put("/", this.mainPushPowerDoc),
        this.initMainPushPowerDoc())
    }
    ...
    getNativeIconUrl(e) {
      ...
      if ("folder" === e.toLowerCase())
        return this.windowCmp.isLinux ? this.folderIconPath ? (0,
          H.pathToFileURL)(this.folderIconPath).href : "nativeicon://unknow" : "nativeicon://folder";
      if (e.startsWith("."))
      ...
      let t = !1;
      try {
        t = f().lstatSync(e).isDirectory()
      } catch (e) { }
      if (t)
        return this.windowCmp.isLinux ? this.folderIconPath ? (0,
          H.pathToFileURL)(this.folderIconPath).href : "nativeicon://unknow" : this.windowCmp.isMacOs && /\.app$/i.test(e) ? "nativeicon://" + e : "nativeicon://folder";
    ...
    async removeLocalOpen(e) {
      ...
      if (0 === t.files.length)
        return;
      let i;
      if (t.files = t.files.filter((t => !e.includes(at + t))),
    ...
    showNativeWorkWindowInfo(e) {
      ...
      i.removeMenu(),
        ...
        i.loadFile(c().join(__dirname, "windowinfo", "index.html"), {
          search: "data=" + encodeURIComponent(JSON.stringify(e))
        })
    }
    getWindowsExplorerCurrentDirctoryPath(e) {
      const t = v().getExplorerWindowsForDirectoryPath(e.id);
      if (0 === t.length)
        return;
      let i;
      if (1 === t.length)
      ...
      return i ? c().resolve(decodeURI(i.replace(/^file:\/\/\//, ""))) : void 0
    }
    readCurrentFolderPath() {
      return new Promise(((e, i) => {
        ...
        return this.windowCmp.isMacOs ? "com.apple.finder" !== n.bundleId ? i(new Error('当前活动窗口非 "访达" 窗口')) : void et().exec("osascript -e 'tell application \"Finder\" to get the POSIX path of (target of front window as alias)'", {
          encoding: "utf8"
        }, ((t, n, o) => {
          if (t) {
    ...
    readCurrentBrowserUrl() {
      return new Promise(((e, t) => {
        ...
        if (this.windowCmp.isWindow) {
          ...
          v().readBrowserWindowUrl(n, i.id, (o => {
            if (!o)
              return "chrome" === n ? void setTimeout((() => {
                v().readBrowserWindowUrl(n, i.id, (i => {
                  if (i)
                    return e(i);
    ...
    schemeRedirect(e, t = !0) {
      ...
      if (-1 === o) {
        if (i = e.split("/"),
          ...
          if (i[0].length > 80)
            return;
          return void this.windowCmp.ffffffff.redirectPluginStore(JSON.stringify({
            label: i
          }))
        }
      } else
        i = e.substring(0, o).split("/"),
          n = e.substring(o + 1);
      try {
        this.redirect({
          label: i,
    ...
    redirect(e) {
      ...
      if ("string" == typeof o) {
        ...
        if (!Array.isArray(o))
          throw new Error("第一个参数错误");
        {
          if (2 !== o.length || "string" != typeof o[0] || "string" != typeof o[1] || !o[0] || !o[1] || o[0].length > 80 || o[1].length > 80)
            throw new Error("第一个参数错误");
          n = o[0],
            o = o[1];
      ...
      do {
        ...
        if (s = {
          ...
          !["text", "files", "img"].includes(s.type) || !s.data)
          throw new Error("第二个参数错误");
        if ("text" === s.type && ("string" != typeof s.data || !s.data))
          throw new Error("text 错误");
        if ("files" === s.type) {
          if ("string" == typeof s.data) {
            if (!f().existsSync(s.data))
              throw new Error("文件不存在");
            try {
              const e = f().lstatSync(s.data);
              s.data = [{
                isFile: e.isFile(),
                isDirectory: e.isDirectory(),
                name: c().basename(s.data),
                path: s.data
              }]
            } catch {
              throw new Error("文件不存在")
          ...
          if (Array.isArray(s.data)) {
            ...
            if (s.data.forEach((t => {
              ...
              0 === e.length)
              throw new Error("文件都不存在");
            s.data = e;
            break
          }
          throw new Error("files 错误")
        }
        if ("img" === s.type && ("string" != typeof s.data || !s.data.startsWith("data:image/")))
          throw new Error("img 错误")
      } while (0);
      this.windowCmp.mainWindow.isVisible() || this.windowCmp.display.trigger(!0),
        i && 0 === i.length ? this.windowCmp.ffffffff.redirectPluginStore(JSON.stringify(e)) : this.windowCmp.mainWindow.webContents.executeJavaScript(`window.rpcRenderer.redirectFeature(${JSON.stringify({
          pluginIds: i,
          label: o,
          payload: s,
          isScheme: r
        })})`).then((e => {
          e || (i ? new t.Notification({
            body: `无法跳转应用「${n}」，未匹配到关键字 "${o}"`
          }).show() : this.windowCmp.ffffffff.redirectPluginStore(JSON.stringify({
            label: o
          })))
        }
        ))
  ...
  class lt {
    constructor(e, t) {
      ...
      i = this,
        ...
        (n = function(e) {
          ...
          return "symbol" == typeof t ? t : String(t)
        }(n = "ffffffffServices")) in i ? Object.defineProperty(i, n, {
          value: o,
          enumerable: !0,
          configurable: !0,
          writable: !0
    ...
    unregisterHotKey(e) {
      const i = I(e);
      Je.isFKey(i) ? Je.unregister(i) : t.globalShortcut.isRegistered(i) && t.globalShortcut.unregister(i)
    }
    ...
    setFeatureHotKey(e, t) {
      t && this.registerHotKey(t, (() => {
        ...
        t && (this.callHotkeyRuningTimeout || (t.autocopy ? this.callHotkeyRuningTimeout = setTimeout((() => {
          ...
          const e = () => {
            const e = v().getClipboardChangeCount();
            this.windowCmp.isWindow ? v().simulateKeyboardTap("c", "ctrl") : this.windowCmp.isMacOs ? v().simulateKeyboardTap("c", "command") : this.windowCmp.isLinux && v().simulateKeyboardTap("c", "ctrl"),
              setTimeout((() => {
                const i = v().getClipboardChangeCount() > e;
  ...
  class ut {
    constructor(e, i, o) {
      dt(this, "initDefaultPanelMenus", (async () => {
        const e = ["截图", "取色", "显示桌面", "锁屏", ...this.windowCmp.isWindow ? ["计算器", "记事本"] : [], {
          label: "计算稿纸",
          pluginId: "calc"
        }]
          , t = this.windowCmp.pluginsCmp.pluginContainer
          , i = []
          , n = "panelmenus/"
          , o = Date.now().toString().substring(0, 11);
        let s = 0;
        e.forEach((e => {
          s++;
          const r = parseInt(o + (s < 10 ? "0" + s : s));
          "string" != typeof e ? e.pluginId in t && (e._id = n + x(e.pluginId + "/" + e.label),
            e.createAt = r,
            i.push(e)) : i.push({
              _id: n + x("/" + e),
              pluginId: "",
        ...
        dt(this, "createVoicePanelMenu", (async (e, t, i) => {
          this.panelMenusDocsCache = null;
          const n = "panelmenus/" + x(e + "/" + i);
          let o = await this.dbCmp.get("/", n);
          if (o) {
            if (o.featureCode === t)
              return;
        ...
        dt(this, "_savePanelMenuSort", (async e => {
        ...
        dt(this, "removeVoicePanelMenu", (async e => {
          const t = await this.getPanelMenusDocs()
            , i = t.findIndex((t => t._id === e._id));
          if (-1 !== i) {
        ...
        dt(this, "getPanelMenusDocs", (async () => {
        ...
        dt(this, "win32MouseButtonDownCall", ((e, i) => {
          if (!this.voiceWindow.isVisible())
            return void v().stopMouseButtonDownEvent();
        ...
        dt(this, "voiceServices", {
          getXFAuthStr: (e, t) => {
            const i = `api_key="8b3ee022a0035a9d2edc93a67c606eca", algorithm="hmac-sha256", headers="host date request-line", signature="${v().xfSignature(`host: iat-api.xfyun.cn\ndate: ${t}\nGET /v2/iat HTTP/1.1`).toString("base64")}"`;
          ...
          isSimulateCopyForClipboardUpdate: e => {
            e.returnValue = v().getClipboardChangeCount() > this._simulateCopyClipboardChangeCount
          }
          ,
          enterPlugin: (e, t, i) => {
          ...
          voiceTextInput: (e, i) => {
            this.reportCmp.info("voice.input"),
              this.windowCmp.isLinux ? (this.clipboardCmp.temporaryCancelWatch(),
                t.clipboard.writeText(i),
                v().simulateKeyboardTap("v", "ctrl")) : [...(new Intl.Segmenter).segment(i)].forEach((e => {
                  v().unicodeType(e.segment)
                }
                ))
          }
          ,
          getCNPinyin: (e, t) => {
            e.returnValue = me.getSpell(t)
          }
          ,
          ...
          translate: async e => {
            const t = this.accountCmp.getAccountToken();
            try {
              const i = await G(this.config.translateURL + (t || ""), {
                body: e,
                mid: this.accountCmp.machineId,
                nid: this.accountCmp.nativeId
              });
        ...
        dt(this, "ffffffffServices", {
          ...
          getVoicePanelMenu: async (e, t, i) => {
            const n = await this.dbCmp.get("/", "panelmenus/" + x(t + "/" + i));
            e.returnValue = n
          }
          ,
          setEnableVoicePanel: (e, t) => {
            if (t) {
              ...
              n().set("enableVoicePanel", !1),
                this.voiceWindow && !this.voiceWindow.isDestroyed() && (this.windowCmp.isMacOs && v().panelRestoreToWindow(this.voiceWindow.getNativeWindowHandle()),
          ...
          setVoicePanelTriggerWay: (e, t) => {
            ...
            i && (i = ";" + i + ";"),
              v().voicePanelTriggerEvent(this.nativeVoicePanelTrigger, this._triggerWay, i),
              e.returnValue = !0
          }
          ,
            ...
            "string" == typeof t ? (this._setProcessBlacklistTimeout && clearTimeout(this._setProcessBlacklistTimeout),
              this._setProcessBlacklistTimeout = setTimeout((() => {
                this._setProcessBlacklistTimeout = null,
                  ...
                  v().setVoicePanelProcessBlacklist(t ? ";" + t + ";" : "")
              }
              ), 500),
              e.returnValue = !0) : e.returnValue = !1
          }
    ...
    enableVoicePanel() {
      this._useVoice = R() && !0 === n().get("voicePanelUseVoice"),
        ...
        ,
        this.windowCmp.isLinux && et().spawn("xmodmap", ["-e", '"pointer = 1 25 3 4 5 6 7 8 9 10"'], {
          shell: !0,
          detached: !0
        })
    }
    triggerShow(e, i) {
      ...
      do {
        ...
        if (this.windowCmp.isMacOs) {
          this.clipboardCmp.temporaryCancelWatch(),
            this._simulateCopyClipboardChangeCount = v().getClipboardChangeCount(),
            v().simulateKeyboardTap("c", "command"),
        ...
        if (this.windowCmp.isWindow) {
          ...
          if (["explorer.exe", "SearchApp.exe", "SearchHost.exe", "FESearchHost.exe"].includes(o.app)) {
            ...
            if ("CabinetWClass" === o.class || "ExploreWClass" === o.class) {
              const e = v().getExplorerWindowsForSelectedFilePaths(o.id);
              if (1 === e.length)
                t = e[0].selectedFiles;
              else if (e.length > 1) {
                ...
                t = v().getExplorerSelectedFilePathByItemIndex(i[0].itemIndex)
              }
            } else
              "Progman" !== o.class && "WorkerW" !== o.class || (t = v().getDesktopSelectedFilePath());
            if (t) {
              const e = [];
              if (t.forEach((t => {
                let i;
          ...
          this.clipboardCmp.temporaryCancelWatch(),
            this._simulateCopyClipboardChangeCount = v().getClipboardChangeCount(),
            ["cmd.exe", "powershell.exe", "WindowsTerminal.exe"].includes(o.app) ? v().simulateKeyboardTap("insert", "ctrl") : v().simulateKeyboardTap("c", "ctrl"),
        ...
        if (this.windowCmp.isLinux) {
          if ((o.app === t.app.name.toLowerCase() || this.windowCmp.isDev && "electron" === o.app) && o.id === this.voiceWindow.getNativeWindowHandle().readInt32LE())
            break;
          ...
          if (v().wheelMouseDownIsSelection()) {
    ...
    handleNativeMouseUp() {
      if (!this.voiceWindow)
        return void v().stopVoicePanelTriggerEvent();
      if (!this.voiceWindow.isVisible())
        return;
      ...
      e || this._isCursorInWindow ? (this._isCursorInWindow = !1,
        this.voiceWindow.webContents.executeJavaScript(`window.bridge.holdUp(${e})`).then((e => {
          e && (this.windowCmp.isWindow ? v().mouseButtonDownEvent(this.win32MouseButtonDownCall) : this.windowCmp.isMacOs ? v().focusShowWindow(this.voiceWindow.getNativeWindowHandle()) : this.voiceWindow.show())
        }
        ))) : this.triggerEmpty()
    }
    triggerHide(e) {
        ...
        case 7:
          this._mouseLongDownTimeout && clearTimeout(this._mouseLongDownTimeout),
            this._mouseLongDownTimeout = setTimeout((() => {
              v().triggerMouseLongDown() && this.triggerShow(t, i),
    ...
    initVoiceWindow() {
      this.voiceWindow = new t.BrowserWindow({
        ...
        this.windowCmp.isMacOs ? (this.voiceWindow.setWindowButtonVisibility(!1),
          ...
          v().windowConvertToPanel(this.voiceWindow.getNativeWindowHandle())) : this.voiceWindow.setAlwaysOnTop(!0, "pop-up-menu"),
        this.voiceWindow.on("will-resize", (e => {
          e.preventDefault()
        }
        )),
        this.voiceWindow.loadFile(c().join(__dirname, "voice.html")),
        ...
        this.voiceWindow.webContents.once("dom-ready", (() => {
          ...
          e && (e = ";" + e + ";"),
            v().voicePanelTriggerEvent(this.nativeVoicePanelTrigger, this._triggerWay, e)
        }
        )),
        ...
        this.voiceWindow.webContents.once("render-process-gone", (() => {
          this.windowCmp.isMacOs && v().panelRestoreToWindow(this.voiceWindow.getNativeWindowHandle()),
            this.voiceWindow.destroy()
        }
        )),
        ...
        this.voiceWindow.on("hide", (() => {
          this.windowCmp.isWindow && (v().stopMouseButtonDownEvent(),
  ...
  const wt = {
    saveimage: {
      ...
      func: (e, i, n) => {
        if (e.windowCmp.hideMainWindow(),
          ...
          return;
        const o = RegExp.$1
          , s = c().join(t.app.getPath("downloads"), Date.now() + "." + o);
        f().writeFile(s, n.replace(/^data:image\/([a-z]+);base64,/, ""), "base64", (e => {
    ...
    showfolder: {
      ...
      func: (e, i, n) => {
        (n = n.trim()).startsWith("~") && (n = n.replace("~", t.app.getPath("home"))),
          n = c().normalize(n),
          f().existsSync(n) || (n = c().dirname(n),
            f().existsSync(n)) ? (e.windowCmp.hideMainWindow(!1),
              f().lstat(n, ((e, i) => {
    ...
    openitem: {
      ...
      func: (e, i, n) => {
        let o = n.trim();
        o.startsWith("~") && (o = o.replace("~", t.app.getPath("home"))),
          o = c().normalize(o),
          f().existsSync(o) ? (e.windowCmp.hideMainWindow(!1),
            t.shell.openPath(o)) : new t.Notification({
              body: '"' + o + '" 文件不存在'
            }).show()
      }
    },
    openweburl: {
      feature: {
        code: "openweburl",
        explain: "默认浏览器打开网址",
        icon: "res/native/open-in-browser.png",
        cmds: [{
          type: "regex",
          match: '/^(?:https?:\\/\\/)?(?:localhost|(?:(?:25[0-5]|2[0-4]\\d|1\\d\\d|[1-9]\\d|\\d)(?:\\.(?:25[0-5]|2[0-4]\\d|1\\d\\d|[1-9]\\d|\\d)){3})|(?:(?:[a-z\\u00a1-\\uffff0-9]-*)*[a-z\\u00a1-\\uffff0-9]+)(?:\\.(?:[a-z\\u00a1-\\uffff0-9]-*)*[a-z\\u00a1-\\uffff0-9]+)*(?:\\.(?:[a-z\\u00a1-\\uffff]{2,}))\\.?)(?::\\d{2,5})?(?:[/?#][^\\s"]*)?$/mi',
          label: "打开网址"
        }]
      },
      func: (e, i, n) => {
        e.windowCmp.hideMainWindow(!1);
        const o = /^(?:https?:\/\/)?(?:localhost|(?:(?:25[0-5]|2[0-4]\d|1\d\d|[1-9]\d|\d)(?:\.(?:25[0-5]|2[0-4]\d|1\d\d|[1-9]\d|\d)){3})|(?:(?:[a-z\u00a1-\uffff0-9]-*)*[a-z\u00a1-\uffff0-9]+)(?:\.(?:[a-z\u00a1-\uffff0-9]-*)*[a-z\u00a1-\uffff0-9]+)*(?:\.(?:[a-z\u00a1-\uffff]{2,}))\.?)(?::\d{2,5})?(?:[/?#][^\s"]*)?$/i;
        n.trim().split(/(?:\r?\n)+/).forEach((e => {
          e = e.trim(),
            o.test(e) && t.shell.openExternal(/^https?:\/\//.test(e) ? e : "https://" + e)
        }
        ))
      }
    },
    ...
    copyfilename: {
      ...
      func: (e, i, n) => {
        e.windowCmp.hideMainWindow(),
          t.clipboard.writeText(n.map((e => e.isFile ? c().parse(e.path).name : e.name)).join("\n"))
      }
    },
  ...
  class ft {
        ...
        nativeOpen: (e, i, n) => {
          if (this.reportCmp.info("native.open", {
            ...
            if (this.windowCmp.hideMainWindow(!1),
              /\.sh$/i.test(i))
              try {
                return f().accessSync(i, f().constants.X_OK),
                  void et().spawn(i, {
                    detached: !0
                  })
              } catch (e) { }
              ...
              try {
                if (f().lstatSync(i).isFile())
                  return void et().spawn("osascript", [i], {
                    detached: !0
                  })
              } catch (e) { }
            t.shell.openPath(i)
    ...
    dirAppRead(e, t, i, n, o) {
      ...
      if (0 !== s.length)
        for (const r of s) {
          ...
          a.isDirectory() ? c().extname(s) === e ? o.push(s) : n < i && this.dirAppRead(e, s, i, n + 1, o) : a.isSymbolicLink() && ".app" === c().extname(s) && o.push(s)
        }
    }
    dirAppWatch(e, t) {
      return pt().watch(e, {
        ...
        /\.app$/.test(e) && setTimeout((() => {
          f().existsSync(e) && (this.pluginsCmp.setFeature("", this.convertAppFeature(e)),
            this.windowCmp.refreshCmdSource())
        }
        ), 1e4)
      }
        ...
        /\.app$/.test(e) && setImmediate((() => {
          f().existsSync(e) || e in this.pluginsCmp.pluginContainer[""].featureDic && (delete this.pluginsCmp.pluginContainer[""].featureDic[e],
            this.windowCmp.refreshCmdSource())
        }
        ))
      }
    ...
    copyFile(e) {
      Array.isArray(e) || (e = [e]),
        0 !== (e = e.filter((e => f().existsSync(e)))).length && v().copyFile.apply(null, e)
    }
    killAllPlugin() {
    ...
    windowScreenshot() {
      ...
      e && (this.windowCmp.hideMainWindow(),
        setTimeout((() => {
          if (!v().isHadScreenCaptureAccess())
            return new t.Notification({
              body: "无屏幕录制权限，在「安全性与隐私」->「隐私」中允许屏幕录制权限"
            }).show(),
              void v().requestScreenCaptureAccess();
          const i = v().windowScreenshot(e.id);
    ...
    showDesktop() {
      ...
      f().existsSync(e) ? et().spawn(e, ["1"], {
        detached: !0
      }) : et().spawn(e.replace("/System", ""), ["1"], {
        detached: !0
      })
    }
    getLanIp() {
  ...
  const yt = [{
    ...
    , bt = {
      saveimage: {
        ...
        func: (e, i, n) => {
          if (e.windowCmp.hideMainWindow(),
            ...
            return;
          const o = RegExp.$1
            , s = c().join(v().getDownloadsFolderPath() || t.app.getPath("desktop"), Date.now() + "." + o);
          f().writeFile(s, n.replace(/^data:image\/([a-z]+);base64,/, ""), "base64", (e => {
            e || t.shell.showItemInFolder(s)
          }
          ))
      ...
      filedialog_select_path: {
        ...
        func: (e, i, n) => {
          e.windowCmp.hideMainWindow();
          let o = v().getAllExplorerWindowLocationUrls();
          if (0 === o.length)
            return void new t.Notification({
          ...
          let s = [...new Set(o)].map((e => c().resolve(decodeURI(e.replace(/^file:\/\/\//, "")))));
          s = s.filter((e => f().existsSync(e))),
            1 !== s.length ? (s.push("取消"),
              t.dialog.showMessageBox({
                ...
                e !== s.length - 1 && (v().setFolderToFilePopUpDialog(n.id, s[e]) || (t.clipboard.writeText(s[e]),
                  v().simulateKeyboardTap("l", "ctrl"),
                  setTimeout((() => {
                    v().simulateKeyboardTap("v", "ctrl"),
                      v().simulateKeyboardTap("enter")
                  }
                  ), 200)))
              }
              ))) : v().setFolderToFilePopUpDialog(n.id, s[0]) || (t.clipboard.writeText(s[0]),
                v().simulateKeyboardTap("l", "ctrl"),
                setTimeout((() => {
                  v().simulateKeyboardTap("v", "ctrl"),
                    v().simulateKeyboardTap("enter")
  ...
  class St {
      ...
      vt(this, "mainServices", {
        nativeOpen: (e, i, n) => {
          ...
          if (/^([A-Za-z]:\\|\\\\)/.test(i)) {
            ...
            e && (i = i.replace("<administrator>", "")),
              i = c().normalize(i),
              this.windowCmp.hideMainWindow(!1),
              e && v().adminShellExecute(i) || t.shell.openPath(i)
          } else {
        ...
        this.screencaptureCmp = s.screencaptureCmp,
        this.screencolorpickerCmp = s.screencolorpickerCmp,
        this.osVersion = parseFloat(m().release()),
        this.isWindows11 = this.osVersion >= 10 && parseInt(m().release().split(".").pop()) >= 22e3,
          ...
          if ("Visual Studio Code" !== e) {
            if ("PowerShell" === e)
              return r.includes("'") ? void new t.Notification({
                body: "路径包含特殊字符 '"
              }).show() : void et().spawn("start", ["powershell", "-noexit", "-command", `"Set-Location '${r}'"`], {
                shell: "cmd.exe",
                detached: !0
              });
            if ("CMD" === e) {
    ...
    setLnkFeatures() {
      ...
      const n = v().getLnksInfo.apply(null, e);
      this.lnkNameTargetDic = {},
        n.forEach((e => {
          void 0 !== e.target && (e.name = c().parse(e.path).name,
            ("" === e.target || "%comspec%" === e.target || [".exe", ".msc", ".bat", ".ico"].includes(c().extname(e.target).toLowerCase())) && (this.lnkNameTargetDic[(e.name + e.target).toLowerCase()] = e))
        }
        ));
      const o = [];
      Object.values(this.lnkNameTargetDic).forEach((e => {
        ...
        if ("" === e.target || 0 === e.target.indexOf("%")) {
          const i = v().getLnkLocalName(e.path);
          i && e.name !== i && t.cmds.unshift(i)
        }
        if (0 === e.target.indexOf("%")) {
          let i = c().basename(e.target);
          ["cmd.exe", "WF.msc"].includes(i) && (i = c().parse(i).name,
            t.cmds.push(i),
    ...
    lnkDirWatch(e, t) {
      return pt().watch(e, {
        ...
        i.toLowerCase().startsWith("uninstall") || i.startsWith("卸载") || i.toLowerCase().endsWith("卸载.lnk") || setTimeout((() => {
          if (!f().existsSync(e))
            return;
          const t = v().getLnksInfo(e)[0];
          if (!t)
            return;
          if (t.target) {
            const e = c().extname(t.target).toLowerCase();
            if (![".exe", ".msc", ".bat", ".ico"].includes(e))
              return
          }
          t.name = c().parse(i).name;
    ...
    getUWPLocalString(e, t) {
      ...
      if (0 === t.indexOf("ms-resource:")) {
        ...
        if (t.includes(i))
          return v().getIndirectString(`@{${e}?${t}}`);
        let n = t.replace("ms-resource:", "");
        return 0 === n.indexOf("/") ? (n = n.replace(/^\/+/, "/"),
          v().getIndirectString(`@{${e}?ms-resource://${i}${n}}`)) : n.toLowerCase().indexOf("/resources/") > 0 || 0 === n.toLowerCase().indexOf("resources/") ? v().getIndirectString(`@{${e}?ms-resource://${i}/${n}}`) : v().getIndirectString(`@{${e}?ms-resource://${i}/resources/${n}}`)
      }
      return /&#x[a-f0-9]{2,5};/i.test(t) ? t.replace(/&#x([a-f0-9]{2,5});/gi, ((e, t) => String.fromCharCode(parseInt(t, 16)))) : t
    }
    setUWPFeatures() {
      (v().uwp.getAppxPackage() || []).forEach((e => {
        const t = c().join(e.location, "AppxManifest.xml");
        if (!f().existsSync(t))
          return;
        let i = null;
        try {
          i = f().readFileSync(t, "utf8")
        } catch (e) {
          return
        }
        ...
        if (o)
          for (let t = 0; t < n.length; t++) {
            ...
            if (!a && s.Square150x150Logo && (a = s.Square150x150Logo),
              ...
              continue;
            a = a.replace(/\\/g, "/");
            let l = v().getIndirectString(`@{${e.fullname}?ms-resource://${e.fullname.substr(0, e.fullname.indexOf("_"))}/Files/${a}}`);
    ...
    shutdown(...e) {
      ...
      t.dialog.showMessageBox({
        ...
        1 === t && ("sleep" === e[0] ? et().spawn("rundll32.exe", ["powrprof.dll,SetSuspendState", "0,1,0"], {
          detached: !0
        }) : et().spawn("Shutdown.exe", e, {
          detached: !0
        }))
      }
      ))
    ...
    setNativeWindowAlwaysOnTop() {
      this.windowCmp.hideMainWindow();
      const e = this.windowCmp.display.nativeWorkWindowInfo;
      e && "#32770" !== e.class && ("explorer.exe" !== e.app || "Progman" !== e.class && "WorkerW" !== e.class) && (v().setWindowAlwaysOnTop(e.id) ? (setImmediate((() => {
    ...
    windowScreenshot() {
      ...
      if (i.width >= n.workAreaSize.width || i.height >= n.workAreaSize.height)
        if (v().windowIsZoomed(e.id)) {
          const e = t.screen.dipToScreenRect(null, n.workArea);
          o = v().screenCapture(e.x, e.y, e.width, e.height)
        } else
          o = v().screenCapture(e.x, e.y, e.width, e.height);
      else
        o = v().windowScreenshot(e.id, n.scaleFactor, this.isWindows11);
      if (o) {
    ...
    showfolder: {
      ...
      func: (e, i, n) => {
        (n = n.trim()).startsWith("~") && (n = n.replace("~", t.app.getPath("home"))),
          n = c().normalize(n),
          f().existsSync(n) || (n = c().dirname(n),
            f().existsSync(n)) ? (e.windowCmp.hideMainWindow(),
              f().lstat(n, ((e, i) => {
                e || i.isFile() ? t.shell.showItemInFolder(n) : t.shell.openPath(n)
              }
              ))) : new t.Notification({
      ...
      func: (e, i, n) => {
        e.windowCmp.hideMainWindow(),
          ...
          setTimeout((() => {
            ...
            e && f().existsSync(e) && et().exec('zenity --title "新建文件" --entry --text "文件名称"', ((i, n, o) => {
              if (i) {
                if (!o)
                  return;
                if (!(o = o.trim()))
  ...
  class kt {
    constructor(e, i, o, s, r) {
      xt(this, "mainServices", {
          ...
          if (this.reportCmp.info("native.open", {
            ...
            if (this.windowCmp.hideMainWindow(),
              ...
              if (i in this.entryFileExec)
                ...
                try {
                  if (f().accessSync(i, f().constants.X_OK),
                    f().lstatSync(i).isDirectory())
        ...
        this.screencolorpickerCmp = s.screencolorpickerCmp,
        this.entryFileExec = {},
        this.emptyIcon = c().join(__dirname, "res/native/linux.png");
      const a = et().execSync("cat /etc/*release | grep -E ^NAME", {
        encoding: "utf8"
      }).toLowerCase();
    ...
    init() {
      n().has("enableNativeApp") || n().set("enableNativeApp", !0);
      let e = null;
      "deepin" === this.osName ? (e = v().getGSetting("com.deepin.dde.appearance", "icon-theme"),
        this.localIconThemes = [e],
        ["deepin", "hicolor"].forEach((e => {
          this.localIconThemes.includes(e) || this.localIconThemes.push(e)
        }
        ))) : "ubuntu" === this.osName && (e = v().getGSetting("org.gnome.desktop.interface", "icon-theme"),
    ...
    getIcon(e) {
      ...
      return f().existsSync(c().join("/usr/share/pixmaps", e + ".png")) ? c().join("/usr/share/pixmaps", e + ".png") : this.emptyIcon
    }
    convertEntryFile2Feature(e) {
      let t = null;
      try {
        t = f().readFileSync(e, "utf8")
      } catch (e) {
        return null
      }
      ...
      if (s.startsWith("/")) {
        ...
        s = c().join(process.env.HOME, ".local/share/icons", s + ".png"),
          f().existsSync(s) || (s = this.emptyIcon)
      }
      let r = "";
      const a = process.env.LANG.split(".")[0];
      r = "Comment[" + a + "]" in n ? n["Comment[" + a + "]"] : n.Comment ? "X-Ubuntu-Gettext-Domain" in n ? v().getLocaleName(n["X-Ubuntu-Gettext-Domain"], n.Comment) : n.Comment : e;
      ...
      if ("Name[" + a + "]" in n) {
        ...
        const e = v().getLocaleName(n["X-Ubuntu-Gettext-Domain"], n.Name);
    ...
    dirAppRead(e, t, i, n, o) {
      ...
      if (0 !== s.length)
        for (const r of s) {
          const s = c().join(t, r);
          try {
            if (!f().lstatSync(s).isFile())
              continue
          } catch (e) {
            continue
          }
          c().extname(s) === e ? o.push(s) : n < i && this.dirAppRead(e, s, i, n + 1, o)
        }
    }
    appDirWatch(e, t) {
      return pt().watch(e, {
        ...
        /\.desktop$/i.test(e) && e in this.pluginsCmp.pluginContainer[""].featureDic && (".desktop" === c().extname(e).toLowerCase() && delete this.entryFileExec[e],
          delete this.pluginsCmp.pluginContainer[""].featureDic[e],
          this.windowCmp.refreshCmdSource())
      }
      )).on("add", (e => {
    ...
    showDesktop() {
      this.windowCmp.hideMainWindow(),
        "deepin" === this.osName ? setTimeout((() => {
          v().simulateKeyboardTap("d", "super")
        }
        ), 50) : setTimeout((() => {
          v().simulateKeyboardTap("d", "ctrl", "alt")
        }
        ), 50)
    }
    shutdown(...e) {
      ...
      t.dialog.showMessageBox({
        ...
        1 === t && et().spawn("shutdown", ["reboot" === e[0] ? "-r" : "-h", "now"], {
          detached: !0
        })
      }
      ))
    ...
    windowScreenshot() {
      ...
      e && 0 !== e.width && 0 !== e.height ? setTimeout((() => {
        ...
        if (v().screenCaptureToFile(e.x, e.y, e.width, e.height, i)) {
  ...
  class _t {
    constructor(e) {
      ...
      i = this,
        ...
        (n = function(e) {
          ...
          return "symbol" == typeof t ? t : String(t)
        }(n = "screenCaptureServices")) in i ? Object.defineProperty(i, n, {
          value: o,
          enumerable: !0,
          configurable: !0,
          writable: !0
    ...
    action(e) {
      ...
      this.captureImageFile = c().join(t.app.getPath("temp"), "utools_screenshot_" + Date.now() + ".png"),
        v().screenCaptureToFile(a.x, a.y, a.width, a.height, this.captureImageFile) ? (this.isInitedSession || (t.session.fromPartition("utools.screencapture").protocol.registerFileProtocol("capture", ((e, t) => {
          ...
          this.captureWindow = new t.BrowserWindow({
            ...
            webPreferences: {
              ...
              preload: c().join(__dirname, "screencapture/preload.js")
            }
          }),
          ...
          this.captureWindow.loadFile(c().join(__dirname, "screencapture/index.html"))) : new t.Notification({
            title: t.app.name,
            body: "截图失败"
          }).show()
    }
  ...
  class Tt {
    constructor(e) {
      It(this, "handleMacOsScreenColorPickerMouseMove", ((e, i, n) => {
        this.mouseScreenX = e,
          this.mouseScreenY = i;
        ...
        It(this, "handleLinuxScreenColorPickerMouseMove", ((e, i, n) => {
          if (void 0 === e)
            return;
          this.mouseScreenX = e,
            this.mouseScreenY = i;
        ...
        It(this, "handleWindowsScreenColorPickerMouseMove", ((e, i, n, o) => {
          if (0 !== e) {
            if (1 === e)
              return this._workWindowBlurTimeout && clearTimeout(this._workWindowBlurTimeout),
                void setImmediate((() => {
                  this.workWindow ? this.handlePicker() : v().destroyNativeWindow(this.screenshotWindowId)
                }
                ));
            if (2 === e) {
              if (!this.workWindow)
        ...
        It(this, "handlePicker", (() => {
          if (this.workWindow && (this.windowCmp.isWindow ? v().destroyNativeWindow(this.screenshotWindowId) : this.workWindow.destroy(),
    ...
    action(e) {
      ...
      if (this.windowCmp.isMacOs) {
        ...
        this.windowCmp.isWindow && (this.screenshotWindowId = v().colorPickerScreenshot(this.handleWindowsScreenColorPickerMouseMove));
      ...
      const i = {
        ...
        height: this.workWindowHeight,
        webPreferences: {
          preload: c().join(__dirname, "screencolorpicker/pixelPreload.js"),
          nodeIntegration: !1,
          sandbox: !1,
          contextIsolation: !1
        }
      ...
      this.windowCmp.isLinux && (i.type = "dock"),
        ...
        this.workWindow.loadFile(c().join(__dirname, "screencolorpicker", "pixel.html")),
        this.workWindow.once("ready-to-show", (() => {
          ...
          if (this.workWindow.show(),
            ...
            v().simulateMouseMove(Math.round(i.x), Math.round(i.y))
          } else
            this.windowCmp.isMacOs ? (v().screenColorPickerMouseMoveEvent(this.handleMacOsScreenColorPickerMouseMove),
              v().simulateMouseMove(e.x, e.y)) : this.windowCmp.isLinux && (v().screenColorPickerMouseMoveEvent(this.handleLinuxScreenColorPickerMouseMove),
                setTimeout((() => {
                  const i = t.screen.getDisplayNearestPoint(e);
                  this.displayScaleFactor = i.scaleFactor,
                    this.displayScaleFactor > 1 ? v().simulateMouseMove(Math.round(e.x * this.displayScaleFactor), Math.round(e.y * this.displayScaleFactor)) : v().simulateMouseMove(e.x, e.y)
                }
                ), 50))
        }
        )),
        this.workWindow.on("blur", (() => {
          this.windowCmp.isWindow ? this._workWindowBlurTimeout = setTimeout((() => {
            v().destroyNativeWindow(this.screenshotWindowId)
          }
        ...
        this.workWindow.once("closed", (() => {
          this.workWindow = null,
            this.windowCmp.isWindow ? this._workWindowBlurTimeout = null : v().stopScreenColorPickerMouseMoveEvent()
        }
        )),
        this.workWindow.webContents.on("before-input-event", ((e, i) => {
          if (e.preventDefault(),
            ...
            if ("Escape" !== i.key)
              if ("ArrowUp" !== i.key)
                if ("ArrowDown" !== i.key)
                  if ("ArrowLeft" !== i.key)
                    if ("ArrowRight" !== i.key)
                      ...
                      if (e.x === i.x + i.width - 1)
                        return;
                      v().simulateMouseMove(this.mouseScreenX + 1, this.mouseScreenY)
                    }
                  else {
                    const e = t.screen.getCursorScreenPoint()
                      , i = t.screen.getDisplayNearestPoint(e).bounds;
                  ...
                  if (e.y === i.y + i.height - 1)
                    return;
                  v().simulateMouseMove(this.mouseScreenX, this.mouseScreenY + 1)
                }
              else {
                const e = t.screen.getCursorScreenPoint()
                  , i = t.screen.getDisplayNearestPoint(e).bounds;
              ...
              this.windowCmp.isWindow ? v().destroyNativeWindow(this.screenshotWindowId) : this.workWindow.destroy()
        }
        ))
    }
  }
  class Mt {
    ...
    registerTopDotServices() {
      ...
      t.ipcMain.on("topdot.services", ((t, i, ...n) => {
        if (t.sender !== e.topDotWindow?.webContents)
    ...
    registerDeveloperServices() {
      ...
      t.ipcMain.on("developer.services", ((t, n, ...o) => {
        ...
        "function" == typeof r ? r(t, ...o) : t.returnValue = new Error("未知接口")
      }
      )),
  ...
  class Et {
    constructor(e, t) {
      ...
      i = this,
        o = {
          ...
          launchDevPlugin: (e, t) => {
            ...
            if (!i)
              return void (e.returnValue = !1);
            let n;
            const o = Object.values(i.featureDic).find((e => !e.dynamic && (n = e.cmds.find((e => "base" === e.type && !e.weight)),
              !!n)));
            if (n)
              return process.nextTick((() => {
        ...
        (n = function(e) {
          ...
          return "symbol" == typeof t ? t : String(t)
        }(n = "developerServices")) in i ? Object.defineProperty(i, n, {
          value: o,
          enumerable: !0,
          configurable: !0,
          writable: !0
    ...
    buildPluginUpxFile(e, i) {
      return new Promise(((n, o) => {
        ...
        let r;
        try {
          r = JSON.parse(f().readFileSync(s, "utf-8"))
        } catch {
          return o(new Error("plugin.json 文件解析失败"))
        }
        const a = JSON.stringify(Object.assign(r, i))
          , l = t.app.getPath("temp")
          , d = c().join(l, "utools-developer", _());
        Y().createPackageWithOptions(e, d, {
          transform: e => {
            if (e === s)
              return new (At().Transform)({
          ...
          const e = f().createReadStream(d)
            , t = c().join(l, "utools-developer", i.name + "-" + i.version + ".upx")
            , s = f().createWriteStream(t)
            , r = ee().createGzip();
  ...
  class Vt {
    constructor(e, i, n, o) {
      Bt(this, "createPaymentWindow", ((e, i) => {
        const n = e.getBounds()
          ...
          , a = new t.BrowserWindow({
            ...
            webPreferences: {
              ...
              preload: c().join(__dirname, "pay/preload.js")
            }
          });
        a.removeMenu();
        const l = this.windowCmp.isMacOs && this.windowCmp.mainWindow === e;
        l && this.windowCmp.mainWindow.setAlwaysOnTop(!0, "floating"),
        ...
        e.once("resize", d),
          ...
          a.once("closed", (() => {
            e.removeListener("resize", d),
              ...
              l && this.windowCmp.mainWindow.setAlwaysOnTop(!0, "modal-panel", 1)
          }
          )),
          a.loadFile(c().join(__dirname, "pay", "index.html"))
      }
      )),
        Bt(this, "pluginApiServices", {
          openPayment: (e, i, n) => {
            if (O())
              return void (e.returnValue = new Error("无效 API"));
            ...
            r ? (this.createPaymentWindow(s, (e => {
              ...
              if (!s)
                return void e.webContents.executeJavaScript(`window.initRenderError(${JSON.stringify(`未登录 ${t.app.name} 账号`)}, true)`);
              const { goodsId: a, outOrderId: c, attach: l, purchase: d } = n
                , u = {
                  plugin_name: i,
                  goods_id: a,
                  out_order_id: c || "",
              ...
              i.startsWith("dev_") && (u.plugin_name = i.replace("dev_", "")),
                G(this.config.paymentsURL + s, u).then((t => {
                  const i = t.order_id;
                  this.orderResHub[i] = {
                    pluginWebContents: o,
                    status: 0,
                    ...
                    d && (this.orderResHub[i].purchase = 1),
                    e.once("closed", (() => {
          ...
          fetchUserPayments: async e => {
            if (O())
              throw new Error("无效 API");
            e.startsWith("dev_") && (e = e.replace("dev_", ""));
            const t = this.accountCmp.getAccountToken();
            if (!t)
              throw new Error("未登录");
            return await Q(this.config.paymentsURL + t, {
              plugin_name: e
            })
          }
          ,
        ...
        Bt(this, "ffffffffServices", {
          openPluginForeverPayment: (e, i) => {
            ...
            o ? (this.createPaymentWindow(o, (e => {
              ...
              if (!o)
                return void e.webContents.executeJavaScript(`window.initRenderError(${JSON.stringify(`未登录 ${t.app.name} 账号`)})`);
              const { pluginId: s, pluginLogo: r, pluginName: a, goodsId: c } = i;
              G(this.config.paymentsURL + o, {
                plugin_name: s,
                goods_id: c,
                out_order_id: "",
                attach: "",
                ...
                this.orderResHub[i] = {
                  pluginWebContents: n,
                  status: 0,
                  payStatusURL: this.config.payStatusURL.replace("{query}", i) + o
                },
                  e.once("closed", (() => {
                    i in this.orderResHub && 0 === this.orderResHub[i].status && delete this.orderResHub[i]
                  }
                ...
                const s = {
                  pluginLogo: r,
                  pluginName: a,
                  payCodeURL: this.config.payCodeURL.replace("{query}", i) + o,
                  order: t
                };
        ...
        Bt(this, "payServices", {
          ...
          goAccount: e => {
            t.BrowserWindow.fromWebContents(e.sender).destroy(),
              this.windowCmp.ffffffff.goAccount()
          }
          ,
  ...
  class Rt {
    constructor(e, t) {
      this.config = e,
        this.windowCmp = t,
        this.pluginsCmp = t.pluginsCmp,
        this.accountCmp = t.accountCmp
    }
    async boot() {
      const e = await Q(this.config.pluginsURL);
      if (!e?.plugins?.length)
        return;
      const i = t.app.getPath("temp")
        , n = this.windowCmp.config.pluginDownloadURL + "?mid=" + this.accountCmp.machineId + "&nid=" + this.accountCmp.nativeId + "&helpboot=true"
        , o = [];
      for (const t of e.plugins) {
        const e = c().join(i, "utools-" + t.name + "-" + Date.now() + ".upx");
        try {
          await Z(n.replace("{query}", t.name), e),
            await this.pluginsCmp.ffffffffServices.pluginInstall(t.name, e),
            o.push(t.name),
            d().unlinkSync(e)
        } catch { }
      }
  ...
  class Ht {
    constructor(e, i, n, o) {
      Nt(this, "exitAllConnection", (() => {
        ...
        Nt(this, "checkOnlinePing", (() => {
          this._loopCheckOnlinePingTimeout && (clearTimeout(this._loopCheckOnlinePingTimeout),
            this._loopCheckOnlinePingTimeout = null),
            this.loopCheckOnlinePing()
        }
        )),
        Nt(this, "loopCheckOnlinePing", (async () => {
          if (!this._UID_)
        ...
        Nt(this, "sendText", ((e, i, n) => new Promise((o => {
          if (!t.net.online || !this._UID_)
            return o(!1);
          if (!e.lanip || !e.port)
            return o(!1);
          const s = new (Lt().Socket);
          s.setTimeout(Ut),
            s.setEncoding("utf-8"),
            s.connect(e.port, e.lanip, (() => {
              const e = Date.now()
                , t = JSON.stringify({
                  ...
                  secret: p().createHash("md5").update(e + this._UID_ + this.localSocketKey).digest("hex"),
                  method: i
                });
        ...
        Nt(this, "ping", (e => this.sendText(e, "ping"))),
        Nt(this, "sendFile", ((e, i, n, o) => new Promise((s => {
          if (!t.net.online || !this._UID_)
            return s(!1);
          if (!e.lanip || !e.port)
            return s(!1);
          const r = new (Lt().Socket);
          r.setTimeout(Ut),
            r.connect(e.port, e.lanip, (() => {
              const e = JSON.stringify({
                timestamp: o,
                from: this.localSocketKey,
                secret: p().createHash("md5").update(o + this._UID_ + this.localSocketKey).digest("hex"),
                method: "file",
                fileName: i
              });
              r.write(e, "utf-8")
        ...
        Nt(this, "readDirectoryFiles", ((e, i, n) => {
          let o;
          try {
            o = f().readdirSync(i)
          } catch { }
        ...
        Nt(this, "sendFiles", (async (e, i) => {
          ...
          if (n.length === s)
            return new t.Notification({
              body: s + " 个文件已全部发送到远端 " + A(e.platform)
            }).show(),
              void await this.sendText(e, "show-file", o + "-" + i[0].name);
          0 === s ? new t.Notification({
            body: "发送失败"
          }).show() : new t.Notification({
            body: "连接中断，" + s + " 个文件已发送到远端 " + A(e.platform) + "，未发送 " + (n.length - s) + " 个"
          }).show(),
        ...
        Nt(this, "ffffffffServices", {
          detectConnection: async () => {
            ...
            if (!e?.db_sync)
              return {
                type: "error",
                message: "需要登录账号且已开启数据同步！"
              };
            if (!t.net.online)
              return {
                type: "error",
                message: "本地网络未连接互联网！(需要同步您的设备数据)"
              };
            let i;
            try {
            ...
            if (await this.dbCmp.dbInfoDocCount() !== i)
              return {
                type: "warning",
            ...
            {
              type: "connection",
              data: o.sort(((e, t) => t.onlineAt - e.onlineAt))
            }
          }
        }),
        this.pluginsCmp = e,
    ...
    getReceiveDir(e) {
      if (e || (e = n().get("connReceiveDir") || "downloads"),
        "downloads" === e) {
        if (this.windowCmp.isWindow)
          e = v().getDownloadsFolderPath();
        else
          try {
      ...
      try {
        if (!f().existsSync(e) || !f().lstatSync(e).isDirectory())
    ...
    async connectionInit() {
      ...
      if (!e)
        return;
      this._UID_ = p().createHash("md5").update(e.db_secrect_key + e.uid).digest("hex");
      ...
      if (this.localSocketDoc = t.find((e => e._id === this.localSocketKey)),
        ...
        if (i.length > 0 && (i.forEach((e => {
          ...
          return await this.setRemoteSocketFeatures(t),
            this.listenServer ? (this.localSocketDoc.lanip = await E(),
              this.localSocketDoc.onlineAt = Date.now(),
              this.putLocalSocketDoc()) : this.createListenServer(),
            t
      }
      this.listenServer && this.listenServer.close(),
        this.localSocketDoc.hostname = m().hostname(),
        this.localSocketDoc.onlineAt = Date.now(),
    ...
    async setRemoteSocketFeatures(e) {
      ...
      for (const i of e) {
        ...
        const n = "我的 " + A(i.platform) + "「" + i.hostname + "」";
        this.pluginsCmp.setFeature("", {
          code: i._id + "@copy",
          cmds: [{
            type: "over",
    ...
    async createListenServer() {
      this.listenServer && this.listenServer.close(),
        this.localSocketDoc.lanip = await E(),
        this.localSocketDoc.hostname = m().hostname(),
        this.listenServer = Lt().createServer((e => {
          e.setTimeout(Ut),
            e.once("timeout", (() => {
              e.destroy()
            }
            ...
            e.once("data", (i => {
              ...
              if (!this._UID_)
                return void e.destroy();
              if (n.secret !== p().createHash("md5").update(n.timestamp + this._UID_ + n.from).digest("hex"))
                return void e.destroy();
              ...
              if ("folder" === n.method)
                return e.on("data", (e => {
                  ...
                  void e.write("ok");
              if ("file" === n.method) {
                const t = c().join(o, n.fileName + "." + n.timestamp);
                ...
                const i = f().createWriteStream(t);
                return e.once("end", (() => {
                  const e = c().join(o, n.fileName);
                  try {
                    f().existsSync(e) ? f().renameSync(t, c().join(o, n.timestamp + "-" + n.fileName)) : f().renameSync(t, e)
                  } catch { }
                }
                )),
                  e.pipe(i, {
              ...
              if ("show-file" === n.method)
                return e.on("data", (e => {
                  const i = e.toString();
                  let n;
                  (f().existsSync(n = c().join(o, i)) || f().existsSync(n = c().join(o, i.substring(14)))) && t.shell.showItemInFolder(n)
                }
                )),
                  void e.write("ok");
              e.destroy()
    ...
    sendData(e, i, n) {
      ...
      s && (this.windowCmp.hideMainWindow(),
        "over" === i ? this.sendText(s, "text", n).then((e => {
          e ? new t.Notification({
            body: "已复制到远端 " + A(s.platform) + " (对方直接粘贴)"
          }).show() : (new t.Notification({
            body: "发送失败"
          }).show(),
            this.checkOnlinePing())
          ...
          e ? new t.Notification({
            body: "图像已复制到远端 " + A(s.platform) + " (对方直接粘贴)"
          }).show() : (new t.Notification({
            body: "发送失败"
          }).show(),
            this.checkOnlinePing())
  ...
  class Kt {
    constructor(e) {
      jt(this, "handleUnlockScreen", (() => {
        ...
        jt(this, "ffffffffServices", {
          setEnableTopDot: (e, t) => {
            t ? (n().set("enableTopDot", !0),
              this.initTopDotWindow()) : (n().set("enableTopDot", !1),
                this.topDotWindow?.destroy()),
              e.returnValue = !0
          }
        }),
        jt(this, "topdotServices", {
          setPosition: (e, t, i) => {
            this.topDotWindowBounds.x = t,
              this.topDotWindowBounds.y = i,
          ...
          mouseEnter: () => {
            const e = {
              ...this.topDotWindowBounds
            };
            e.width += 2,
              e.height += 2,
              this.topDotWindow.setBounds(e),
              this.topDotWindow.setAlwaysOnTop(!0, "screen-saver")
          }
          ,
          mouseLeave: () => {
            this.topDotWindow.setBounds(this.topDotWindowBounds)
          ...
          ,
          showContextMenu: () => {
            this.windowCmp.isMacOs ? this.topdotContextMenu.popup({
              window: this.topDotWindow,
              x: -5,
              y: 56
            }) : this.topdotContextMenu.popup({
              window: this.topDotWindow,
              x: -14,
              y: 52
            })
          ...
          ,
          openMessageHub: (e, t) => {
            this.windowCmp.ffffffff.goMessageHub(t)
          }
        }),
        this.windowCmp = e
    }
    ...
    init() {
      n().has("enableTopDot") || n().set("enableTopDot", !0),
        this.isEnableTopDot() && this.initTopDotWindow()
    }
    initTopDotWindowBounds() {
      const e = t.screen.getPrimaryDisplay();
      let i = Math.round((e.bounds.height - 600) / 2);
      i < 100 && (i = 100);
      const n = e.bounds.y + i + 5
        , o = e.bounds.x + e.bounds.width - 100;
      this.topDotWindowBounds = {
        x: o,
        y: n,
        width: 56,
    ...
    initTopDotWindow() {
      this.topDotWindow || (this.initTopDotWindowBounds(),
        this.topDotWindow = new t.BrowserWindow({
          resizable: !1,
          focusable: !1,
          fullscreenable: !1,
          minimizable: !1,
          ...
          webPreferences: {
            ...
            webgl: !1,
            enableWebSQL: !1,
            preload: c().join(__dirname, "topdot", "preload.js")
          }
        }),
        this.topDotWindow.removeMenu(),
        this.topDotWindow.setAlwaysOnTop(!0, "screen-saver"),
        this.topDotWindow.webContents.setBackgroundThrottling(!1),
        this.topDotWindow.loadFile(c().join(__dirname, "topdot", "index.html")),
        this.topDotWindow.webContents.once("destroyed", (() => {
          this.topDotWindow = null,
            this.topdotContextMenu = null,
            r().windows() && t.powerMonitor.removeListener("unlock-screen", this.handleUnlockScreen)
        }
        )),
        ...
        this.windowCmp.config.messageBadgeColor && this.topDotWindow.webContents.once("dom-ready", (() => {
          this.topDotWindow.webContents.insertCSS(`.message-badge { background-color: ${this.windowCmp.config.messageBadgeColor}!important; }`)
        }
        )),
        this.topdotContextMenu = t.Menu.buildFromTemplate([{
          label: "设置",
          click: () => {
            process.nextTick((() => {
              this.windowCmp.ffffffff.goSetting()
        ...
        r().windows() && t.powerMonitor.addListener("unlock-screen", this.handleUnlockScreen))
    }
  }
  function Jt(e, t, i) {
    return (t = function(e) {
  ...
  class $t {
    constructor(e, t, i) {
      Jt(this, "getRemoteMessageHubData", (async e => {
        let t;
        try {
          t = await Q(this.config.messagesURL + e)
        } catch { }
        return Array.isArray(t) || (t = []),
          t
      }
      )),
        Jt(this, "setMessageBadge", (e => {
          e > 99 && (e = 99),
            this.messageBadge = e,
            this.windowCmp.mainWindow.webContents.executeJavaScript(`window.rpcRenderer.setMessageBadge(${e})`),
            !this.topdotCmp.topDotWindow && this.topdotCmp.isEnableTopDot() && this.topdotCmp.initTopDotWindow(),
            this.topdotCmp.topDotWindow?.webContents?.executeJavaScript(`window.rpcRenderer.setMessageBadge(${e})`)
        }
        )),
        Jt(this, "loopResetMessageBadge", (async () => {
          ...
          this.messageBadge !== t && this.setMessageBadge(t),
            this._loopResetMessageBadgeTimeout = setTimeout(this.loopResetMessageBadge, this.config.interval)
        }
        )),
        Jt(this, "ffffffffServices", {
          getMessageBadge: e => {
            e.returnValue = this.messageBadge
          }
          ,
          setMessageBadge: (e, t) => {
            "number" == typeof t ? (this.setMessageBadge(t),
              e.returnValue = !0) : e.returnValue = !1
          }
        }),
        this.config = e,
        this.appCmp = t,
        this.windowCmp = t.windowCmp,
        this.accountCmp = t.windowCmp.accountCmp,
        this.topdotCmp = i,
        this.pluginsCmp = t.pluginsCmp,
        this.messageBadge = 0
    }
    init() {
      R() ? this.pluginsCmp.on("message_badge", (e => {
        this.windowCmp.mainWindow.webContents.executeJavaScript(`window.rpcRenderer.setMessageBadge(1, ${JSON.stringify(e)})`),
          this.topdotCmp.topDotWindow?.webContents?.executeJavaScript(`window.rpcRenderer.setMessageBadge(1, ${JSON.stringify(e)})`)
      }
      )) : (this.accountCmp.on("login", (() => {
        this._accountToken = this.accountCmp.getAccountToken(),
          this.loopResetMessageBadge()
      }
      )),
        this.accountCmp.on("logout", (() => {
          this._accountToken = null,
            clearTimeout(this._loopResetMessageBadgeTimeout),
  ...
  (new class extends o {
    launch() {
      ...
      r().dev() ? t.app.setAsDefaultProtocolClient("utools-dev", process.execPath, [c().resolve(process.argv[1])]) : r().windows() && R() && (t.app.isDefaultProtocolClient("utools") || t.app.setAsDefaultProtocolClient("utools")),
      ...
      if (r().macOS()) {
        ...
        r().windows() ? (t.app.disableHardwareAcceleration(),
          R() ? t.app.setAppUserModelId("org.yuanli.utools") : t.app.setAppUserModelId("org.yuanli.utools.ee")) : r().linux() && t.app.disableHardwareAcceleration();
      const i = !d().existsSync(N.path.settings);
      n().setPath(N.path.settings),
        t.app.on("ready", (() => {
          new class {
            constructor(e) {
              this.container = e
            ...
            register() {
              this.container.set("config", (() => {
                const e = new class {
                  get(e = null, t = null) {
                    return e ? this.getData(e, U, t) : U
                  }
                  set(e, t = {}) {
                    return "object" == typeof e ? this.setObject(U, e) : "string" == typeof e && "" !== e && void this.setData(e, U, t)
                  }
                  getData(e, t, i) {
                    if (-1 === e.indexOf("."))
                  ...
                  return new class {
                    ...
                    netPost() {
                      if (t.net.online && 0 !== this.reportQueue.length) {
                        ...
                        G(this.config.logsURL + this.accountCmp.getAccountToken(), [...this.reportQueue]).catch((() => { }
                        )),
                          this.reportQueue = []
                      }
                    }
                ...
                this.container.set("plugins", (() => {
                  const e = this.container.get("config")
                    ...
                    , i = this.container.get("account");
                  return new xe(c().join(__dirname, "plugins"), e.get("path.plugins"), e.get("plugin"), t, i)
                }
                ), !0),
                this.container.set("clipboard", (() => {
                  const e = this.container.get("config")
                    , t = this.container.get("plugins");
                  return new Ze(e.get("path.clipboardData"), t)
                }
                ), !0),
                this.container.set("window", (() => {
                  ...
                  return new class {
                    constructor(e, i, o, s, a) {
                      Fe(this, "forceLoginUse", (() => !(!this.config.isForceLogin || this.accountCmp.isLogined() || (this.accountCmp.showLoginWindow(),
                        0)))),
                        Fe(this, "_updatePluginWaitPushArgsDic", {}),
                        Fe(this, "mainServices", {
                          getMainMode: e => {
                            e.returnValue = n().get("mainMode") ? 1 : 0
                          }
                          ,
                          getPlaceholder: e => {
                            e.returnValue = this.config.placeholder || t.app.name
                          }
                          ,
                          disableRenderRecent: (e, t, i) => {
                            "boolean" != typeof t && (t = !1),
                              n().set("disableRenderRecent", t),
                              this.mainWindow.webContents.executeJavaScript(`window.disabledRenderRecent=${t};window.rpcRenderer.updateMainCmdMenuRefresh();`),
                              this.reportCmp.info("render.recent", {
                                disabled: t,
                                way: i
                              }),
                              e.returnValue = !0
                          ...
                          ,
                          isDisabledRenderRecent: e => {
                            e.returnValue = !0 === n().get("disableRenderRecent")
                          }
                          ,
                          getPluginContainer: e => {
                          ...
                          ,
                          pushPluginSelectCall: (e, t, i, n, o) => {
                            const s = setTimeout((() => {
                              e.returnValue = !1
                            }
                            ), 1e3);
                            this.pushPluginSelectCall(t, i, n, o).then((t => {
                              e.returnValue = t
                            }
                            )).catch((() => {
                              e.returnValue = !1
                          ...
                          cancelLoadPlugin: (e, t) => {
                            if (this._updatePluginCmdCache?.pluginId === t)
                              return this._updatePluginCmdCache.sessionItem.cancel(),
                                void (e.returnValue = !0);
                        ...
                        Fe(this, "ffffffffServices", {
                          setMainMode: (e, t) => {
                            t = t ? 1 : 0,
                              n().set("mainMode", t),
                              this.mainWindow.webContents.executeJavaScript(`window.rpcRenderer.setMainMode(${t})`),
                              e.returnValue = !0
                          }
                          ,
                        ...
                        Fe(this, "pluginApiServices", {
                          pushMain: (e, t, i) => {
                            ...
                            if (n) {
                              ...
                              e && Array.isArray(n.data) ? n.data.forEach((t => {
                                t.icon && !/^(?:nativeicon|https?|file):\/\//i.test(t.icon) && (t.icon = (0,
                                  H.pathToFileURL)(c().join(e.location, t.icon)).href)
                              }
                              )) : i[1] = void 0
                            }
                          ...
                          createBrowserWindow: (e, i, { url: n, options: o }) => {
                            ...
                            if ((o = o || {}).backgroundColor || (o.backgroundColor = this.getWindowBackgroundColor()),
                              ...
                              o.webPreferences.preload && !o.webPreferences.preload.startsWith(r.location) && (o.webPreferences.preload = c().join(r.location, o.webPreferences.preload),
                                !d().existsSync(o.webPreferences.preload)))
                              return void (e.returnValue = new Error("preload 文件不存在"));
                            const l = new t.BrowserWindow(o);
                            let u;
                            l.removeMenu(),
                              u = this.isMacOs ? (e, t) => {
                              ...
                              ,
                              l.webContents.on("before-input-event", u),
                              l.webContents.on("did-attach-webview", ((e, t) => {
                                t.on("before-input-event", u)
                              }
                              )),
                              l.webContents.once("render-process-gone", (() => {
                                l.destroy()
                              }
                              )),
                              l.loadFile(a, s.length > 1 ? {
                                search: s[1]
                              } : void 0),
                              l.webContents.on("dom-ready", (() => {
                                e.sender.isDestroyed() || (l.webContents.insertCSS('body { font-family: system-ui,"PingFang SC","Helvetica Neue","Microsoft Yahei",sans-serif; }'),
                        ...
                        this.appVersion = t.app.getVersion();
                      const l = n().get("theme");
                      l && ["system", "dark", "light"].includes(l) && (t.nativeTheme.themeSource = l),
                    ...
                    init() {
                      if (n().has("mainMode") || n().set("mainMode", 1),
                        !n().has("disableRenderRecent")) {
                        let e = this.config.disableRenderRecent;
                        "boolean" != typeof e && (e = !1),
                          n().set("disableRenderRecent", e)
                      }
                    ...
                    initNativeIconHandler() {
                      const e = ["unknow"];
                      let i = null;
                      this.isLinux ? (this.nativeIconHandler = (n, o) => n in Ae ? o({
                        mimeType: "image/png",
                        data: Ae[n]
                      }) : e.includes(n) ? o({
                        mimeType: "image/png",
                        ...
                        ))) : (this.nativeIconHandler = (t, n) => t in Ae ? n({
                          mimeType: "image/png",
                          data: Ae[t]
                        }) : e.includes(t) ? n({
                          mimeType: "image/png",
                          data: i
                        }) : void v().fetchFileIconAsPng(t, (o => o ? i.equals(o) ? (o = null,
                          e.push(t),
                          n({
                            mimeType: "image/png",
                            data: i
                      ...
                      return e.on("will-download", ((e, i, n) => {
                        ...
                        i.on("updated", ((e, t) => {
                          ...
                          i.once("done", ((e, n) => {
                            ...
                            if (this._updatePluginCmdCache?.pluginId !== s || !(s in this.pluginsCmp.pluginContainer) || "cancelled" === n) {
                            ...
                            const { featureCode: a, inputCmd: c, timestamp: l } = this._updatePluginCmdCache;
                            if (this._updatePluginCmdCache = null,
                              "completed" !== n)
                              return this.mainWindow.webContents.executeJavaScript("window.rpcRenderer.endAssemblyPlugin()"),
                                void this.reallyEnterPlugin(s, a, c);
                            this.destroyPlugin(s),
                              this.pluginsCmp.install(s, o, (e => {
                                this.pluginsCmp.pluginUpdateSet.splice(this.pluginsCmp.pluginUpdateSet.indexOf(s), 1),
                                  e ? (this.reportCmp.info("plugin.update.fail", {
                                    ...
                                    new t.Notification({
                                      ...
                                      this.reportCmp.info("plugin.update", {
                                        pluginId: s,
                                        pluginVersion: this.pluginsCmp.pluginContainer[s].version,
                                        timeCost: Date.now() - l
                                      })),
                                  this.reallyEnterPlugin(s, a, c, !0);
                                try {
                                  d().unlinkSync(o)
                                } catch (e) { }
                              }
                    ...
                    initMainWin() {
                      this.mainWindow = new t.BrowserWindow({
                        ...
                        this.isWindow ? this.mainWindow.setAlwaysOnTop(!0, "pop-up-menu") : this.isMacOs && (this.mainWindow.setAlwaysOnTop(!0, "modal-panel", 1),
                          ...
                          v().windowConvertToPanel(this.mainWindowNativeWindowHandle)),
                        this.display = new _e(this.mainWindow, this.mainWindowNativeWindowHandle, this.config.initWidth + 2 * this.mainWindowBorderWidth, this.config.initHeight + 2 * this.mainWindowBorderWidth, this.forceLoginUse),
                        this.mainWindow.loadFile(c().join(__dirname, "index.html")),
                        ...
                        this.mainWindow.on("will-resize", (e => {
                          e.preventDefault(),
                            this.mainWindow.getBrowserView() && this.detachPlugin("resize")
                        }
                        )),
                        ...
                        return this.isWindow ? (this.display.mainWindowBlurTimestamp = Date.now(),
                          this.display.mainWindowBlurTimestamp - this.display.mainWindowShowTimestamp < 250 ? (this.display.trigger(!0, !0),
                            void setImmediate((() => {
                              ...
                              v().isMouseLeftDown() ? this.win32CheckMouseLeftUp() : this.hideMainWindow()
                            }
                        ...
                        this.win32CheckMouseLeftUpTimer = setTimeout((() => {
                          ...
                          if (e) {
                            ...
                            if (t > n.x && t < n.x + n.width && i > n.y && i < n.y + n.height) {
                              if (this.mainWindow.focus(),
                                i > n.y + this.config.initHeight) {
                                const e = this.mainWindow.getBrowserView();
                                e?.webContents?.focus()
                              }
                              return
                    ...
                    reallyEnterPlugin(e, i, n, o) {
                      ...
                      if (!s)
                        return void this.emptyRecovery();
                      /*chandlerver5 if (s.illegal)
                          return this.destroyPlugin(e),
                          this.emptyRecovery(),
                          void (R() ? new t.Notification({
                              title: "安全检测",
                    ...
                    async pushPlugin(e, i, n) {
                      let o = this.pluginsCmp.pluginContainer[e];
                      /*chandlerver5
                      if (!o || o.illegal)
                          return;
                          */
                      if (this.pluginsCmp.pluginUpdateSet.includes(e)) {
                        if (e in this._updatePluginWaitPushArgsDic)
                          return void (this._updatePluginWaitPushArgsDic[e][i] = [n.key, {
                            code: i,
                            type: n.type,
                            payload: n.payload
                          }]);
                        this._updatePluginWaitPushArgsDic[e] = {
                          [i]: [n.key, {
                            code: i,
                            type: n.type,
                            payload: n.payload
                        ...
                        try {
                          const i = c().join(t.app.getPath("temp"), _() + ".upx")
                            , n = this.config.pluginDownloadURL.replace("{query}", e) + "?mid=" + this.accountCmp.machineId + "&nid=" + this.accountCmp.nativeId + "&update=true";
                          if (await Z(n, i),
                            this.destroyPlugin(e),
                            await new Promise(((t, n) => {
                              this.pluginsCmp.install(e, i, (e => {
                                if (e)
                                  return n(e);
                                t()
                              }
                            ...
                            o = this.pluginsCmp.pluginContainer[e],
                            !o)
                            return
                        } catch { }
                        this.pluginsCmp.pluginUpdateSet.splice(this.pluginsCmp.pluginUpdateSet.indexOf(e), 1)
                      }
                      let s = this.runningPluginPool[e];
                      if (s) {
                        if (s.view) {
                          if (s._waitPushArgs)
                            return void (s._waitPushArgs[i] = [n.key, {
                              code: i,
                              type: n.type,
                              payload: n.payload
                            }]);
                          s.view.webContents.send("main-push", n.key, {
                            code: i,
                            type: n.type,
                            payload: n.payload
                          })
                        } else if (s.detachWindows.length > 0) {
                          const e = s.detachWindows[Math.floor(Math.random() * s.detachWindows.length)].getBrowserView();
                          if (!e)
                            return;
                          e.webContents.send("main-push", n.key, {
                            code: i,
                            type: n.type,
                            payload: n.payload
                          })
                        ...
                        this.assemblyPlugin(o),
                          s = this.runningPluginPool[e],
                          s?.view && (e in this._updatePluginWaitPushArgsDic ? (s._waitPushArgs = this._updatePluginWaitPushArgsDic[e],
                            delete this._updatePluginWaitPushArgsDic[e]) : s._waitPushArgs = {
                              [i]: [n.key, {
                                code: i,
                                type: n.type,
                                payload: n.payload
                            ...
                            s.view.webContents.once("dom-ready", (() => {
                              s._waitPushArgs && (Object.values(s._waitPushArgs).forEach((e => {
                                s.view.webContents.send("main-push", ...e)
                              }
                              )),
                                delete s._waitPushArgs)
                            }
                            )))
                    }
                    async pushPluginSelectCall(e, t, i, n) {
                      const o = this.runningPluginPool[e];
                      if (!o)
                        return;
                      let s;
                      if (o.view?.webContents?.id === n)
                        s = o.view;
                      else if (o.detachWindows?.length > 0) {
                        const e = o.detachWindows.find((e => e.getBrowserView()?.webContents?.id === n));
                        e && (s = e.getBrowserView())
                      }
                      if (!s?.webContents || s.webContents.isDestroyed())
                        return;
                      let r = !0;
                      if (await s.webContents.executeJavaScript('typeof window.utools?.__event__?.onMainPushSelectCallback === "function"')) {
                        const e = {
                          code: t,
                          type: i.type,
                          payload: i.payload,
                        ...
                        this.hideMainWindow(),
                          r = await s.webContents.executeJavaScript(`try { window.utools.__event__.onMainPushSelectCallback(${JSON.stringify(e)}) === true } catch { false }`),
                          r && this.display.trigger(!0)
                      }
                      return r
                    }
                    enterPlugin(e, i, n) {
                      if (this.forceLoginUse())
                        return void this.emptyRecovery();
                      if (!e)
                        return void this.emptyRecovery();
                    ...
                    triggerPluginViewEvent(e, i, n, o) {
                      ...
                      r.push(i);
                      if (["PluginEnter", "PluginReady"].includes(i)) {
                    ...
                    assemblyPlugin(e, i, n) {
                      if (void 0 !== i && this.mainWindow.webContents.executeJavaScript("window.rpcRenderer.startAssemblyPlugin()"),
                        ...
                        this.pluginSessionPool[e.name] = i,
                          ...
                          i.setPreloads([c().join(__dirname, "apisdk.js")])
                      }
                      const o = {
                      ...
                      e.name in this.runningPluginPool ? this.runningPluginPool[e.name].view = s : this.runningPluginPool[e.name] = {
                        ...
                        e.isTpl ? s.webContents.loadFile(c().join(__dirname, "tpl", "index.html")) : s.webContents.loadURL(e.main);
                    ...
                    setPluginWindowAppDetails(e, i) {
                      if ("string" == typeof i && (i = this.pluginsCmp.pluginContainer[i]),
                        !i)
                        return;
                      const n = c().join(t.app.getPath("temp"), "utools-icons")
                        , o = c().join(n, i.name + "-" + (i.version || "").replace(/\./g, "-") + ".ico")
                        , s = (R() ? "org.yuanli.utools." : "org.yuanli.utools.ee.") + i.name;
                      if (d().existsSync(o))
                        e.setAppDetails({
                          appId: s,
                          appIconPath: o
                    ...
                    detachPlugin(e) {
                      ...
                      if (!i)
                        return;
                      const n = t.webContents.isFocused()
                        , o = {
                          ...this.display.mainWindowBounds
                        };
                      this.mainWindow.setBrowserView(null),
                        this.mainWindow.hide(),
                        this.mainWindow.webContents.executeJavaScript("window.rpcRenderer.getEnterFeatureCmd()").then((s => {
                    ...
                    detachPluginLogic(e, i, n, o, s, r, a) {
                      this.emptyRecovery();
                      const l = this.pluginsCmp.pluginContainer[e];
                      let d = l.logo;
                      const u = l.featureDic[i.featureCode]?.icon;
                      u && u.startsWith("file://") && (d = u);
                      let h = new t.BrowserWindow({
                        show: !1,
                        frame: !this.isLinux,
                        autoHideMenuBar: !0,
                        titleBarStyle: "hidden",
                        ...
                        webPreferences: {
                          ...
                          webgl: !1,
                          enableWebSQL: !1,
                          preload: c().join(__dirname, "detach", "preload.js")
                        }
                      });
                      h.removeMenu(),
                        this.isWindow && "FFFFFFFF" !== e && this.setPluginWindowAppDetails(h, l),
                        this.isMacOs && !t.app.dock.isVisible() && t.app.dock.show(),
                        this.runningPluginPool[e].view = null,
                        this.runningPluginPool[e].detachWindows.push(h),
                        h.loadFile(c().join(__dirname, "detach", "index.html")),
                        h.setMinimumSize(this.config.initWidth, this.config.initHeight + 1),
                        h.webContents.executeJavaScript(`window.initRender(${JSON.stringify({
                          pluginId: e,
                          icon: d,
                          label: i.label,
                          subInput: i.subInput,
                          ...
                          e && e[0] > 0 && e[1] > 0 && (n.width = e[0],
                            n.height = e[1]),
                            h.setBounds(n),
                            n.height > this.config.openPluginHeight / 2 && h.center(),
                            h.show(),
                            ...
                            s || !i.subInput ? o.webContents?.focus() : h.webContents.focus(),
                        ...
                        h.once("close", (t => {
                          ...
                          const n = Boolean(h.getBrowserView());
                          this.triggerPluginViewEvent(o, "PluginOut", n, (() => {
                            n ? (h.setBrowserView(null),
                        ...
                        this.isWindow ? (h.on("maximize", (() => {
                          h.webContents.executeJavaScript("window.api.maximizeTrigger()");
                          const e = h.getBrowserView();
                          if (!e)
                            return;
                          const i = t.screen.getDisplayMatching(h.getBounds());
                          e.setBounds({
                            x: 0,
                            y: this.config.initHeight,
                          ...
                          h.on("unmaximize", (() => {
                            h.webContents.executeJavaScript("window.api.unmaximizeTrigger()");
                            const e = h.getBrowserView();
                            if (!e)
                              return;
                            const i = h.getBounds()
                          ...
                          ))) : this.isMacOs ? (h.on("enter-full-screen", (() => {
                            h.webContents.executeJavaScript("window.api.enterFullScreenTrigger()")
                          }
                          )),
                            h.on("leave-full-screen", (() => {
                              h.webContents.executeJavaScript("window.api.leaveFullScreenTrigger()")
                            }
                            ))) : this.isLinux && h.on("linux-maximize", (() => {
                              const e = h.getBounds()
                                , i = t.screen.getDisplayMatching(e);
                              h.setBounds(i.workArea),
                                h.setMovable(!1),
                                h.setResizable(!1);
                              const n = h.getBrowserView();
                              n && (n.webContents.focus(),
                                setTimeout((() => {
                                  !h.isDestroyed() && h.listenerCount("linux-unmaximize") > 0 && n.setBounds({
                                    x: 0,
                                    y: this.config.initHeight,
                                    width: i.workArea.width,
                                    height: i.workArea.height - this.config.initHeight
                                ...
                                h.once("linux-unmaximize", (() => {
                                  h.setBounds(e),
                                    h.setMovable(!0),
                                    h.setResizable(!0);
                                  const t = h.getBrowserView();
                        ...
                        h.on("page-title-updated", (e => {
                          e.preventDefault()
                        }
                        )),
                        h.webContents.once("render-process-gone", (() => {
                          h.close()
                        }
                        )),
                        h.on("blur", (() => {
                          h.webContents.executeJavaScript("window.subInputBlurTimestamp").then((e => {
                            s = !e || Date.now() - e > 100
                          }
                          ))
                        }
                        ...
                        l.isDev || this.reportCmp.info("plugin.detach", {
                          pluginId: e,
                          way: a
                        })
                    }
                    ...
                    refreshAccountInfo(e) {
                      ...
                      e && (t = {
                        ...
                        R() && 1 === t.type && (t.mainPlaceholder = n().get("mainPlaceholder") || "")),
                      ...
                      this.accountCmp.on("login", (e => {
                        ...
                        this.accountCmp.on("logout_message", (e => {
                          setTimeout((() => {
                            ...
                            this.config.isForceLogin || t.dialog.showMessageBox({
                ...
                this.container.set("database", (() => {
                  ...
                  return new Re(e.get("path.database"), e.get("database"), t, i, n)
                }
                ), !0),
                ...
                this.container.set("helpboot", (() => {
                  const e = this.container.get("config").get("helpboot")
                    , t = this.container.get("window");
                  return new Rt(e, t)
                }
                ), !0),
                ...
                this.container.set("autoupdate", (() => {
                  const e = this.container.get("window")
                    , i = this.container.get("voice")
                    , n = this.container.get("report");
                  return new class {
                    constructor(e, i, n) {
                      Ke(this, "noticeUpdate", (e => {
                        ...
                        Ke(this, "mainServices", {
                          appUpdate: () => {
                            this.newVersionIsDownloaded && (this._appUpdating || (this._appUpdating = !0,
                              ...
                              )) : r().macOS() && (v().panelRestoreToWindow(this.windowCmp.mainWindow.getNativeWindowHandle()),
                                this.voiceCmp.voiceWindow && v().panelRestoreToWindow(this.voiceCmp.voiceWindow.getNativeWindowHandle()),
                                t.app.dock.hide(),
                                t.app.hide()),
                              r().linux() || v().stopClipboardWatch(),
                              v().stopVoicePanelTriggerEvent(),
                              v().stopFKeyTapEvent(),
                              t.globalShortcut.unregisterAll(),
                              setTimeout((() => {
                    ...
                    init() {
                      ...
                      /*chandlerver5 "function" != typeof v().compareServerSignature && setImmediate((()=>{
                    ...
                    updateWatch() {
                      this.newVersionIsDownloaded || (Le.autoUpdater.checkForUpdates().catch((e => {
                ...
                this.container.set("menu", (() => new Oe(this.container.get("app"))), !0),
                this.container.set("preferences", (() => new $e(this.container.get("window"))), !0),
                ...
                this.container.set("pluginmenu", (() => new je(this.container.get("app"))), !0),
                ...
                r().macOS() ? this.container.set("nativeapp", (() => {
                  ...
                  const e = this.container.get("plugins")
                    ...
                    , n = this.container.get("app")
                    , o = this.container.get("connection")
                    , s = this.container.get("topdot");
                  return new St(e, t, i, n, o, s)
                }
                  ...
                  const e = this.container.get("plugins")
                    ...
                    , n = this.container.get("app")
                    , o = this.container.get("connection");
                  return new kt(e, t, i, n, o)
                }
                ), !0),
                this.container.set("messagehub", (() => {
                  const e = this.container.get("config").get("messagehub")
                    , t = this.container.get("app")
