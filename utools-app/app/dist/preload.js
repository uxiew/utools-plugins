...
window.services = {
    ...
    sendPluginSomeKeyDownEvent: (e,n,i,r,s)=>{
        const t = [];
        return n && t.push("control"),
        i && t.push("shift"),
        r && t.push("alt"),
        s && t.push("meta"),
        ipcRenderer.sendSync("main.services", "sendPluginSomeKeyDownEvent", e, t)
    }
    ,
    isFFFFFFFFRuning: ()=>ipcRenderer.sendSync("main.services", "isFFFFFFFFRuning"),
    ...
    ,
    voice: {
        getPanelMenusDocs: ()=>ipcRenderer.invoke("voice.services", "getPanelMenusDocs"),
        joinPanelMenusFolder: (e,n)=>ipcRenderer.invoke("voice.services", "joinPanelMenusFolder", e, n),
        removePanelMenus: e=>ipcRenderer.invoke("voice.services", "removePanelMenus", e),
        outPanelMenusFolder: e=>ipcRenderer.invoke("voice.services", "outPanelMenusFolder", e),
        sortPanelMenus: (e,n)=>ipcRenderer.invoke("voice.services", "sortPanelMenus", e, n),
        updatePanelMenusFolderLabel: (e,n)=>ipcRenderer.sendSync("voice.services", "updatePanelMenusFolderLabel", e, n),
        ...
        windowFocus: ()=>ipcRenderer.sendSync("voice.services", "windowFocus"),
        ...
        showMainWindowToInput: ()=>{
            ipcRenderer.send("voice.services", "showMainWindowToInput")
        }
        ,
        translate: e=>ipcRenderer.invoke("voice.services", "translate", e),
        registerMouseMoveEvent: e=>{
            ipcRenderer.on("mousemove", ((n,i,r,s)=>{
                e(i, r, s)
            }
            ))
        }
...
window.addEventListener("error", (function(e) {
    ipcRenderer.send("main.services", "reportExceptionError", e.error.stack)
}
));
