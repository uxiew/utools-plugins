...
window.services = {
    ...
    getVoicePanelMenusDocs: ()=>ipcInvoke("getVoicePanelMenusDocs"),
    ...
    ,
    getFileName: e=>path.parse(e).name,
    openPluginForeverPayment: (e,n)=>{
        "function" == typeof n ? window.utools.__event__.openPaymentCallback = n : delete window.utools.__event__.openPaymentCallback,
        ipcSendSync("openPluginForeverPayment", e)
    }
    ,
    detectConnection: ()=>ipcInvoke("detectConnection")
};
