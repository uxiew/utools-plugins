  ...
  <div class="package-tabs">
    ...
    <section>
      <div v-if="keywords.length" class="tab0">
        <div class="tags_list">
          <a v-for="item in keywords" :key="item" class="tag_link" @click="searchKeyWords(item)">
            {{ item }}
          </a>
        </div>
      </div>
      ...
      <div v-if="dependents.length" class="tab2">
        <div class="tags_list">
          <a v-for="item in dependents" :key="item" class="tag_link" @click="getInfo(item)">
            {{ item }}
          </a>
        </div>
      </div>
      <div v-if="versArrObj" class="tab3">
        <div class="version-list">
          <div v-for="(value, key, index) in versArrObj" :key="index" class="version-list-row">
