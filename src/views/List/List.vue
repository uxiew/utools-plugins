  ...
  <div class="list">
    ...
    >
      ...
      <div class="list-item-content">
        ...
        ><span class="pkg-name">{{ name }}</span><span class="hint">{{ version }}</span>
          <span v-if="owner">
            <span
              v-if="license"
              class="license"
        ...
        >
          <a class="owner">
            <img
              ...
              height="28"
              alt="owner"
              :src="`https://res.cloudinary.com/hilnmyskv/image/fetch/w_40,h_40,f_auto,q_80,fl_lossy/${owner.avatar}`"
            >{{ owner.name }}</a>
