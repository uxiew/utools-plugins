const r = function(e: number, t: number) {
  var n, r, i, a, o;
...
const s = function(e: number, t: number, n: number) {
  return t ^ (e | ~n);
};

const n = function(e: number, t: number) {
  return (e << t) | (e >>> (32 - t));
};
const i = function(e: number, t: number, n: number) {
  return (e & t) | (~e & n);
};
...
const a = function(e: number, t: number, n: number) {
  return (e & n) | (t & ~n);
};
const o = function(e: number, t: number, n: number) {
  return e ^ t ^ n;
};
const u = function(
  e: number,
...
// ==============
/*function generateSaltSign(text: string) {
   const t = md5(navigator.appVersion);
  const r = '' + new Date().getTime();
  const i = r + parseInt(10 * Math.random() + '', 10);

  return {
    ts: r,
    bv: t,
    salt: i,
    sign: md5('fanyideskweb' + text + i + 'mmbP%A-r6U3Nw(n]BjuEU')
  };
} */
// =========
