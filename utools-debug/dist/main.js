(()=>{
    ...
    class Me extends (se()) {
        ...
        remoteAccountInfo(e, i) {
            ...
            w(this.config.profileURL, {
                ...
                401 !== e.code && 403 !== e.code || n().has("account") && setTimeout((()=>{
                    this.logout(),
                    new t.Notification({
                        title: "uTools",
                        body: "uTools 帐号密钥已失效，已退出帐号，请知悉"
                    }).show()
                }
                )),
            ...
            wt(this, "pluginApiServices", {
                openPayment: (e,i,n)=>{
                    ...
                    r ? (this.createPaymentWindow(r, (e=>{
                        const {goodsId: t, outOrderId: r, attach: a, permanent: c} = n
                          , l = {
                            plugin_name: i,
                            goods_id: t,
                            out_order_id: r || "",
                        ...
                        c && (l.forever = 1),
                        i.startsWith("dev_") && (l.plugin_name = i.replace("dev_", "")),
                        m(this.config.paymentsURL + o, l).then((t=>{
                            ...
                            c && (this.orderResHub[r].permanent = 1),
                            e.once("closed", (()=>{
                ...
                isPermanentUser: (e,t)=>{
                    ...
                    Array.isArray(i?.purchased) ? (t.startsWith("dev_") && (t = t.replace("dev_", "")),
                                    ...
                                    n.permanent) {
                                        ...
                                        this.accountCmp.remoteAccountInfo(e, (e=>{
                                            e && new t.Notification({
                                                title: "uTools 支付完成",
                                                body: "获取帐号数据出错了，尝试重启 uTools | " + e.message
                                            }).show()
                                        }
                                        ))
                                    }
    ...
    class yt {
        ...
        help(e=!1) {
            if (this.helpWindow)
                return void this.helpWindow.show();
            const i = 1e3
              , [n,o] = this.getWindowPos(i, 600);
            ...
            this.helpWindow.loadFile(c().join(__dirname, "help/index.html")),
        ...
        boot() {
            ...
            this.bootWindow = new t.BrowserWindow({
                ...
                webPreferences: {
                    partition: "utools.helpboot",
                    preload: c().join(__dirname, "boot/preload.js"),
                    nodeIntegration: !1,
                    sandbox: !1,
                    contextIsolation: !1
                }
            ...
            this.bootWindow.loadFile(c().join(__dirname, "boot/index.html")),
                            ...
                            return new class {
                                ...
                                assemblyPlugin(e, i, n) {
                                    ...
                                    !(e.name in this.pluginSessionPool)) {
                                        ...
                                        this.isMacOs && i.setPermissionRequestHandler(((e,i,n)=>{
                                            n("fullscreen" !== i || t.BrowserWindow.fromWebContents(e) !== this.mainWindow)
                                        }
                                        ))
                                    }
                                    const o = {
                                    ...
                                    r.webContents.once("dom-ready", (()=>{
                                        ...
                                        void 0 === i)
                                            return this.triggerPluginViewEvent(r, "PluginReady");
                                                    ...
                                                    if ("paste" === n) {
                                                        ...
                                                        return i === this.mainWindow ? void this.mainWindow.webContents.executeJavaScript("window.rpcRenderer.getEnterFeatureCmd()").then((t=>{
                                                            ...
                                                            n && n.cmds.find((t=>t.type === e)) && this.mainWindow.webContents.executeJavaScript(`window.rpcRenderer.getPasteInputCmdForSameFeature(${JSON.stringify({
                                                                ...
                                                                e && this.triggerPluginViewEvent(r, "PluginOut", !1, (()=>{
